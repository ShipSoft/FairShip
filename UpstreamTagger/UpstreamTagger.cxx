...
void UpstreamTagger::ConstructGeometry()
{
    ...
    ybox_fulldet = 289 * cm;   // resize box to define the modules position from active area of the detectors
    ...
    for (auto&& i : TSeq(1, n_modules + 1)) {
        ...
        UpstreamTagger_fulldet->AddNode(
            Rpc_module_upstream1, i, new TGeoTranslation(module[i][0], module[i][1], module[i][2]));
        UpstreamTagger_fulldet->AddNode(Rpc_module_upstream,
                                        i + n_modules,
