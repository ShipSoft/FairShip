...
class UpstreamTagger: public FairDetector
{
  ...
  private:
    ...
    Double_t     det_xStripPos;     //!  x-size of Strip
    Double_t     det_yStripPos;     //!  y-size of Strip
    Double_t     det_zStripPos;     //!  z-size of Strip
    
    Double_t xbox_fulldet = 217; 
    Double_t ybox_fulldet = 491; //???? 45 x 10
    Double_t zbox_fulldet = 7.8012; //2.9006; 0.3012 
    Double_t z_space_layers = 0.2;  
    //Double_t extra_y = 4.87516; 
