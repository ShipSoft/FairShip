...
// -----   Default constructor   --------------
UpstreamTaggerHit::UpstreamTaggerHit() : ShipHit()
{
   flag = true;
}

// -----   constructor from TimeDetPoint from TimeDetHit-------------------------------
UpstreamTaggerHit::UpstreamTaggerHit(UpstreamTaggerPoint *p, UpstreamTagger *c, Double_t t0) : ShipHit()
{
...
TGeoNode *UpstreamTaggerHit::GetNode(Double_t &hit_final, Int_t &mod)
{
   ...
   c0->ybox_fulldet = 499; // resize box to define the modules position from active area of the detectors (discounting
...
{
   cout << "-I- UpstreamTaggerHit: UpstreamTagger hit "
