...
ShipConstField::ShipConstField(const char* name, Double_t xMin, Double_t xMax,
                               Double_t yMin, Double_t yMax, Double_t zMin,
                               Double_t zMax, Double_t bX, Double_t bY,
                               Double_t bZ)
    : FairField(name),
      fXmin(xMin),
      fXmax(xMax),
...
// -----   Set field region   ----------------------------------------------
void ShipConstField::SetFieldRegion(Double_t xMin, Double_t xMax, Double_t yMin,
