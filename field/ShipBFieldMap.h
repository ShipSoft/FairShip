...
public:
   ...
   */
   ShipBFieldMap(const std::string &label, const std::string &mapFileName, Float_t xOffset = 0.0, Float_t yOffset = 0.0,
                 Float_t zOffset = 0.0, Float_t phi = 0.0, Float_t theta = 0.0, Float_t psi = 0.0, Float_t scale = 1.0,
   ...
   */
   ShipBFieldMap(const std::string &newName, const ShipBFieldMap &rhs, Float_t newXOffset, Float_t newYOffset,
                 Float_t newZOffset, Float_t newPhi = 0.0, Float_t newTheta = 0.0, Float_t newPsi = 0.0,
