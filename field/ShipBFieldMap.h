...
class ShipBFieldMap : public TVirtualMagField {
 public:
  ...
  /*!
    ...
    \param [in] mapFileName The name of the field map file (distances in cm,
    fields in Tesla)
    \param [in] xOffset The x global coordinate shift to position the field map
    (cm)
    \param [in] yOffset The y global coordinate shift to position the field map
    (cm)
    \param [in] zOffset The z global coordinate shift to position the field map
    (cm)
    \param [in] phi The first Euler rotation angle about the z axis (degrees)
    \param [in] theta The second Euler rotation angle about the new x axis
    (degrees)
    \param [in] psi The third Euler rotation angle about the new z axis
    (degrees)
  ...
  */
  ShipBFieldMap(const std::string& label, const std::string& mapFileName,
                Float_t xOffset = 0.0, Float_t yOffset = 0.0,
                Float_t zOffset = 0.0, Float_t phi = 0.0, Float_t theta = 0.0,
                Float_t psi = 0.0, Float_t scale = 1.0,
  ...
  /*!
    \param [in] rhs The ShipBFieldMap object to be copied (retaining any
   symmetry)
    ...
    \param [in] newTheta The second Euler rotation angle about the new x axis
   (degrees)
    \param [in] newPsi The third Euler rotation angle about the new z axis
   (degrees)
    \param [in] newScale The field magnitude scaling factor (default = 1.0)
   \returns a copy of the field map object "rhs", keeping the same fieldMap
   pointer
  */
  ShipBFieldMap(const std::string& newName, const ShipBFieldMap& rhs,
                Float_t newXOffset, Float_t newYOffset, Float_t newZOffset,
                Float_t newPhi = 0.0, Float_t newTheta = 0.0,
  ...
  */
  ...
  //! Get the second Euler rotation angle about the new x axis for global
  //! positioning
  /*!
    \returns the map's second Euler rotation angle about the new x axis
    (degrees)
  */
  Float_t GetTheta() const { return theta_; }

  //! Get the third Euler rotation angle about the new z axis for global
  //! positioning
  /*!
  ...
  */
  ...
  /*!
    ...
    z)
    \returns the bin number and fractional distance from the leftmost bin edge
    as a pair
  */
  ...
  */
  ...
  //! Flag to specify if we are a copy of the field map (just a change of global
  //! offsets)
  Bool_t isCopy_;
