...
// -----   Default constructor   -------------------------------------------
ShipGoliathField::ShipGoliathField() : FairField() {}
// -------------------------------------------------------------------------

// -----   Standard constructor   ------------------------------------------
ShipGoliathField::ShipGoliathField(const char *name) : FairField(name) {}
// -------------------------------------------------------------------------
...
void ShipGoliathField::Init(const char *fieldfile)
{
   ...
   for (Int_t i=0;i<13;i++){
     ...
     //std::cout<<volume[i]<<" "<<coords[i][3] << " posX " << posX <<" "<< coords[i][0] << ";" << coords[i][4] << " posY
   "<< posY <<" "<<  coords[i][1] << ";" << coords[i][5] << " posZ " << posZ<<" "<< coords[i][2]<<std::endl;
   }
   */
}
