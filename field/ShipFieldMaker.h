...
public:
   ...
   */
   ...
   /*!
     ...
     \param [in] BVector The vector of B field components (Bx, By, Bz) in Tesla
   */
   void defineConstant(const TString &name, const TVector2 &xRange, const TVector2 &yRange, const TVector2 &zRange,
   ...
   */
   void defineBell(const TString &name, Double_t BPeak, Double_t zMiddle, Int_t orient = 1, Double_t tubeR = 500.0,
   ...
   */
   void defineFieldMap(const TString &name, const TString &mapFileName,
                       ...
                       const TVector3 &localAngles = TVector3(0.0, 0.0, 0.0), Bool_t useSymmetry = kFALSE);
   ...
   */
   void defineFieldMapCopy(const TString &name, const TString &mapNameToCopy, const TVector3 &translation,
   ...
   */
   void defineComposite(const TString &name, const TString &field1Name, const TString &field2Name,
   ...
   */
   ...
   /*!
     ...
     \param [in] field4Name The name of the fourth field (optional)
   */
   void defineGlobalField(const TString &field1Name, const TString &field2Name = "", const TString &field3Name = "",
   ...
   */
   ...
   void generateFieldMap(TString fileName, const float step = 2.5, const float xRange = 179, const float yRange = 317,
                         const float zRange = 1515.5, const float zShift = -4996);
