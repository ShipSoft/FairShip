...
# Environment
echo 'export CXXFLAGS="-fPIC -g -O2 -std=c++11"' >> $INSTALLROOT/etc/profile.d/init.sh
echo 'export CFLAGS="-fPIC -g -O2"' >> $INSTALLROOT/etc/profile.d/init.sh
echo 'export CMAKE_BUILD_TYPE="RELEASE"' >> $INSTALLROOT/etc/profile.d/init.sh
