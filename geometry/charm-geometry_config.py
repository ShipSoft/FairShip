...
with ConfigRegistry.register_config("basic") as c:
    ...
    c.PixelModules.D1long = ((78 * 250.) + 450. + 500.) * u.um * 2
    ...
    c.Spectrometer.SZ = c.Spectrometer.DZ*2 + c.PixelModules.zSi[c.PixelModules.numSi-1] - \
        c.PixelModules.zSi[0] + c.PixelModules.DimZSithick + 80 * u.cm + 4.5*u.m  # 4.5 m is the Goliath length
...
#   Need to add SciFi
    ...
    if c.MufluxSpectrometer.muflux == True:
        ...
        c.MuonTagger.zBox = c.Spectrometer.zBox + c.PixelModules.DimZpixelbox/2. + PixeltoGoliath + \
            c.Spectrometer.TS + 261*u.cm + c.MuonTagger.BZ/2.  # real position of MuonTagger
