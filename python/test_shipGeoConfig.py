...
class TestSingleConfig(unittest.TestCase):
    ...
    def test_key(self):
        assert self.key in list(ConfigRegistry.keys())
...
class TestInheritance(unittest.TestCase):
    ...
    def test_len(self):
        assert len(list(ConfigRegistry.keys())) == 2

    def test_key(self):
        assert "bb" in list(ConfigRegistry.keys())
        assert "cc" in list(ConfigRegistry.keys())
