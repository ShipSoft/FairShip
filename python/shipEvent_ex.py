...
def exMCTracks():
    ut.bookHist(h, "pz", "pz", 100, 0.0, 100.0)
    ut.bookHist(h, "oz", "oz", 100, -10000.0, 10000.0)
...
def exMCHits(dump=False):
    ut.bookHist(h, "tz", "tracking hits z", 100, -100.0, 100.0)
    ut.bookHist(h, "tztx", "tracking hits x vs z", 1000, -40.0, 40.0, 100, -2.5, 2.5)
