"""
This module defines physical units and constants used in HEP, which are imported
from CLHEP library, matched to be used for FAIROOT.
...
Units imported from "SystemOfUnits.h".
"""
