...
class TrackingBenchmark:
    ...
    def print_summary(self) -> None:
        ...
        print(
            f"  Hit resid RMS:    {fmt(m['hit_residual_rms']['value'], m['hit_residual_rms']['uncertainty'], '.6f')} cm"
        )
        print(f"  Hit pull mean:    {fmt(m['hit_pull_mean']['value'], m['hit_pull_mean']['uncertainty'])}")
        print(f"  Hit pull sigma:   {fmt(m['hit_pull_sigma']['value'], m['hit_pull_sigma']['uncertainty'])}")
        print(
