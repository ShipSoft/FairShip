...
#        self.trackingGeometry = detector.trackingGeometry()
    ...
    def actsTracks(self) -> None:
        ...
        print(f"straw hits {len(self.strawHits)}")
        print(f"tracks {len(self.MCTracks)}")
        print(self.strawHits[0][5],self.strawHits[0][6],self.strawHits[0][7])
        actsTracks = runTracking(
