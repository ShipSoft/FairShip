...
#-----   Magnetic field   -------------------------------------------
 if ship_geo.strawDesign == 4 or ship_geo.strawDesign == 10 or ship_geo.strawDesign == 11: fMagField = ROOT.ShipBellField("wilfried", ship_geo.Bfield.max ,ship_geo.Bfield.z,2,ship_geo.Yheight/2.*u.m )  
