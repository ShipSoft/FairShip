...
def configure_snd_siliconTarget(yaml_file, ship_geo):
    ...
    if ship_geo.SiliconTarget_geo.zPosition == "auto":
        ...
        # Offset placement of detector by 175 cm, magnet is 2* 212.54 cm, 
        # 50 layers at 55.5 cm will fit.
        ship_geo.SiliconTarget_geo.zPosition = find_shield_center(ship_geo)[2][-2] + 175
