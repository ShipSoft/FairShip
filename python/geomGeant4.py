...
def addVMCFields(shipGeo, controlFile = '', verbose = False, withVirtualMC = True):
    ...
    if hasattr(shipGeo, 'Bfield'):
      ...
      if not shipGeo.hadronAbsorber.WithConstField:
       #new fieldmap from Richard: needs to be raised 50cm
       fieldMaker.defineFieldMap('HadronAbsorberMap','files/FieldHadronStopper_raised_20190902.root', ROOT.TVector3(0.0,50.0,shipGeo.hadronAbsorber.z))       
