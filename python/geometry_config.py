...
"stellatryon_v2": {
        ...
        "params": [ 
                     ...
                     [10, 85.00, 31.00, 107.12, 56.00, 56.00, 5.27, 5.00, 4.55, 0.63, 1.00, 77.12, 0.00, 0.00, -1.91], 
    ...
    "warm_opt": {
        "hybrid": False,
        "WithConstField": True,
        "params": [[0.,120.5, 50.00,  50.00, 119.00, 119.00,   2.00,   2.00, 1.00,1.0,50.00,  50.00,0.0, 0.00, 1.9],
