...
def run():
    ...
    ut.bookHist(
        h, "Bx-", "Bx- component ;z [cm];x [cm];y [cm]", grid[2], zmin, zmax, grid[0], xmin, xmax, grid[1], ymin, ymax
    )
    ut.bookHist(
        h, "By-", "By- component ;z [cm];x [cm];y [cm]", grid[2], zmin, zmax, grid[0], xmin, xmax, grid[1], ymin, ymax
    )
    ut.bookHist(
        h, "Bz-", "Bz- component ;z [cm];x [cm];y [cm]", grid[2], zmin, zmax, grid[0], xmin, xmax, grid[1], ymin, ymax
    )
    ut.bookHist(
        h, "Bx+", "Bx+ component ;z [cm];x [cm];y [cm]", grid[2], zmin, zmax, grid[0], xmin, xmax, grid[1], ymin, ymax
    )
