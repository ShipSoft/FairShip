...
def run():
    ...
    for pol in ["y", "x"]:
        for p in ["_xz", "_yz"]:
            ...
            h["B" + pol + "L" + p].AddEntry(
                h["B" + pol + "+"], "B" + pol + txt[pol][0], "PM"
            )
            h["B" + pol + "L" + p].AddEntry(
                h["B" + pol + "-"], "B" + pol + txt[pol][1], "PM"
            )
            h["B" + pol + "L" + p].Draw()
            h[cn].Update()
