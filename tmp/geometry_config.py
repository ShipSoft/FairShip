...
# size of straws
 ...
 #HPT!
    ...
    #c.UpstreamTagger.Y_Glass = 165 * u.cm
    #c.UpstreamTagger.X_Glass = 109 * u.cm
    ...
    #c.UpstreamTagger.Y_PMMA = 168 * u.cm
    #c.UpstreamTagger.X_PMMA = 112 * u.cm
    ...
    #c.UpstreamTagger.Y_FreonSF6 = 167 * u.cm
    #c.UpstreamTagger.X_FreonSF6 = 111 * u.cm
    ...
    #c.UpstreamTagger.Y_FR4 = 171 * u.cm
    #c.UpstreamTagger.X_FR4 = 115 * u.cm
    c.UpstreamTagger.Y_FR4 = 106 * u.cm
    c.UpstreamTagger.X_FR4 = 211 * u.cm
    c.UpstreamTagger.Z_Aluminium = 1.1503 * u.cm
    #c.UpstreamTagger.Y_Aluminium = 175 * u.cm
    #c.UpstreamTagger.X_Aluminium = 115 * u.cm
    c.UpstreamTagger.Y_Aluminium = 106 * u.cm
    c.UpstreamTagger.X_Aluminium = 215 * u.cm
    c.UpstreamTagger.DZ_Aluminium = 0.1 * u.cm
    #c.UpstreamTagger.DY_Aluminium = 0.2 * u.cm
    #c.UpstreamTagger.DX_Aluminium = 1 * u.cm
    c.UpstreamTagger.DY_Aluminium = 1 * u.cm
    c.UpstreamTagger.DX_Aluminium = 0.2 * u.cm
    c.UpstreamTagger.Z_Air = 1.1503 * u.cm
    #c.UpstreamTagger.Y_Air = 2 * u.cm
    #c.UpstreamTagger.X_Air = 0 * u.cm
    c.UpstreamTagger.Y_Air = 0 * u.cm
    c.UpstreamTagger.X_Air = 2 * u.cm
    c.UpstreamTagger.Z_Strip = 0.0003 * u.cm
    #c.UpstreamTagger.Y_Strip = 171 * u.cm
    #c.UpstreamTagger.X_Strip = 3.3 * u.cm
    c.UpstreamTagger.Y_Strip = 3.0 * u.cm
    c.UpstreamTagger.X_Strip = 211 * u.cm
    c.UpstreamTagger.Z_Position = c.Chamber1.z -c.chambers.Tub1length -7.7997*u.cm + ((c.UpstreamTagger.Z_Aluminium)*1.0) + ((c.UpstreamTagger.DZ_Aluminium)*2.0) + 0.1# safety margin
