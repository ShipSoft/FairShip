...
int main(int argc, char** argv)
{
    ...
    total++;
    if (test_vector_operations<ShipHit>("ShipHit"))
        passed++;
    total++;
    if (test_vector_operations<ShipMCTrack>("ShipMCTrack"))
        passed++;
    total++;
    if (test_vector_operations<vetoHitOnTrack>("vetoHitOnTrack"))
        passed++;

    // Test Hit classes
    std::cout << "\n--- Hit Classes ---" << std::endl;
    total++;
    if (test_vector_operations<vetoHit>("vetoHit"))
        passed++;
    total++;
    if (test_vector_operations<strawtubesHit>("strawtubesHit"))
        passed++;
    total++;
    if (test_vector_operations<splitcalHit>("splitcalHit"))
        passed++;
    total++;
    if (test_vector_operations<MTCDetHit>("MTCDetHit"))
        passed++;
    total++;
    if (test_vector_operations<SiliconTargetHit>("SiliconTargetHit"))
        passed++;
    total++;
    if (test_vector_operations<TimeDetHit>("TimeDetHit"))
        passed++;
    total++;
    if (test_vector_operations<UpstreamTaggerHit>("UpstreamTaggerHit"))
        passed++;

    // Test Point classes
    std::cout << "\n--- Point Classes ---" << std::endl;
    total++;
    if (test_vector_operations<vetoPoint>("vetoPoint"))
        passed++;
    total++;
    if (test_vector_operations<strawtubesPoint>("strawtubesPoint"))
        passed++;
    total++;
    if (test_vector_operations<splitcalPoint>("splitcalPoint"))
        passed++;
    total++;
    if (test_vector_operations<MTCDetPoint>("MTCDetPoint"))
        passed++;
    total++;
    if (test_vector_operations<SiliconTargetPoint>("SiliconTargetPoint"))
        passed++;
    total++;
    if (test_vector_operations<TimeDetPoint>("TimeDetPoint"))
        passed++;
    total++;
    if (test_vector_operations<UpstreamTaggerPoint>("UpstreamTaggerPoint"))
        passed++;
    total++;
    if (test_vector_operations<TTPoint>("TTPoint"))
        passed++;
    total++;
    if (test_vector_operations<TargetPoint>("TargetPoint"))
        passed++;
    ...
    if (passed == total) {
        ...
        std::cout << "All data classes are compatible with std::vector and RNtuple I/O\n" << std::endl;
        return 0;
    } else {
