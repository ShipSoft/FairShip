...
hcalAnalysisSimple::hcalAnalysisSimple(const char *name, const Int_t iVerbose)
   : FairTask(name, iVerbose), fTree(NULL), fX(0.), fY(0.), fCX(0.), fCY(0.), fP(0.), fCE(0.), fCE2(0.), fOE(0.),
     fPX(0.), fPY(0.), fPZ(0.), fEv(0), fModuleNum(0), fADC(0), fStr(NULL), fTracks(NULL)
{
}

hcalAnalysisSimple::hcalAnalysisSimple()
   : FairTask(), fTree(NULL), fX(0.), fY(0.), fCX(0.), fCY(0.), fP(0.), fCE(0.), fCE2(0.), fOE(0.), fPX(0.), fPY(0.),
     fPZ(0.), fEv(0), fModuleNum(0), fADC(0), fStr(NULL), fTracks(NULL)
{
}
