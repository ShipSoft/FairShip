...
// -----   Default constructor   -------------------------------------------
hcal::hcal()
   : FairDetector("HCAL", kTRUE, khcal), fInf(NULL), fDebug(NULL), fTrackID(-1), fVolumeID(-1), fPos(), fMom(),
     fTime(-1.), fLength(-1.), fELoss(-1.), fPosIndex(0), fHcalCollection(new TClonesArray("hcalPoint")),
     fLiteCollection(new TClonesArray("hcalPoint")), fHcalSize(), fSimpleGeo(0), fFastMC(0), fXSize(0), fYSize(0),
     fDX(0.), fDY(0.), fModuleSize(0.), fZHcal(0.), fSemiX(0.), fSemiY(0.), fAbsorber("Lead"), fThicknessAbsorber(0.),
     fThicknessScin(0.), fThicknessTyvk(0.), fThicknessLayer(0.), fThicknessSteel(0.), fEdging(0.), fHoleRad(0.),
     fFiberRad(0.), fXCell(0), fYCell(0), fNH(0), fCF(0), fLightMapName(""), fLightMap(NULL), fNLayers(0),
     fModuleLength(0.), fVolIdMax(0), fFirstNumber(0), fVolArr(), fModule(NULL), fScTile(NULL), fTileEdging(NULL),
     fPbTile(NULL), fTvTile(NULL), fHoleVol(), fFiberVol(), fSteelTapes(), fHolePos(), fModules(0), fRawNumber(),
     fStructureId(0)
{
   fVerboseLevel = 1;
...
hcal::hcal(const char *name, Bool_t active, const char *fileGeo)
   : FairDetector(name, active, khcal), fInf(NULL), fDebug(NULL), fTrackID(-1), fVolumeID(-1), fPos(), fMom(),
     fTime(-1.), fLength(-1.), fELoss(-1.), fPosIndex(0), fHcalCollection(new TClonesArray("hcalPoint")),
     fLiteCollection(new TClonesArray("hcalPoint")), fHcalSize(), fSimpleGeo(0), fFastMC(0), fXSize(0), fYSize(0),
     fDX(0.), fDY(0.), fModuleSize(0.), fZHcal(0.), fSemiX(0.), fSemiY(0.), fAbsorber("Lead"), fThicknessAbsorber(0.),
     fThicknessScin(0.), fThicknessTyvk(0.), fThicknessLayer(0.), fThicknessSteel(0.), fEdging(0.), fHoleRad(0.),
...
hcalPoint *hcal::AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
