...
hcalStructureFiller::hcalStructureFiller()
   : FairTask(), fStr(NULL), fInf(NULL), fListHCALpts(NULL), fEvent(0), fInited(kFALSE), fUseMCPoints(kFALSE),
...
hcalStructureFiller::hcalStructureFiller(const char *name, const Int_t iVerbose, const char *fileGeo)
   : FairTask(name, iVerbose), fStr(NULL), fInf(hcalInf::GetInstance(fileGeo)), fListHCALpts(NULL), fEvent(0),
