...
Scintillator::Scintillator()
   : FairDetector("HighPrecisionTrackers", kTRUE, kScintillator), fTrackID(-1), fPdgCode(), fVolumeID(-1), fPos(),
     fMom(), fTime(-1.), fLength(-1.), fELoss(-1), fScintillatorPointCollection(new TClonesArray("ScintillatorPoint"))
{
}

Scintillator::Scintillator(const char *name, Bool_t Active, const char *Title)
   : FairDetector(name, Active, kScintillator), fTrackID(-1), fPdgCode(), fVolumeID(-1), fPos(), fMom(), fTime(-1.),
     fLength(-1.), fELoss(-1), fScintillatorPointCollection(new TClonesArray("ScintillatorPoint"))
{
}
...
ScintillatorPoint *Scintillator::AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time,
