...
MufluxSpectrometerHit::MufluxSpectrometerHit(Int_t detID, Float_t ftdc, Float_t signal_width, uint16_t flag,
                                             uint16_t ch)
...
{
   std::cout << "-I- MufluxSpectrometerHit: MufluxSpectrometer hit "
             << " in detector " << fDetectorID << std::endl;
