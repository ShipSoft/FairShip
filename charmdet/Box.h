...
public:
   Box(const char *name, const Double_t BX, const Double_t BY, const Double_t BZ, const Double_t zBox, Bool_t Active,
   ...
   void AddEmulsionFilm(Double_t zposition, Int_t nreplica, TGeoVolume *volTarget, TGeoVolume *volEmulsionFilm,
   ...
   void SetEmulsionParam(Double_t EmTh, Double_t EmX, Double_t EmY, Double_t PBTh, Double_t EPlW, Double_t PasSlabTh,
                         Double_t AllPW);
   void SetPassiveComposition(Double_t Molblock1Z, Double_t Molblock2Z, Double_t Molblock3Z, Double_t Molblock4Z,
   ...
   BoxPoint *AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
