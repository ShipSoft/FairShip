...
MufluxReco::MufluxReco(TTreeReader *t)
{
   ...
   fChain->SetBranchAddress("Digi_MufluxSpectrometerHits", &cDigi_MufluxSpectrometerHits,
                            &b_Digi_MufluxSpectrometerHits);
...
void MufluxReco::trackKinematics(Float_t chi2UL, Int_t nMax)
{
   ...
   std::vector<TString> h2names = {"p/pt",         "p/px",         "p/Abspx",      "xy",
                                   "pxpy",         "p1/p2",        "pt1/pt2",      "p1/p2s",
                                   "pt1/pt2s",     "momResol",     "Fitpoints_u1", "Fitpoints_v2",
                                   "Fitpoints_x1", "Fitpoints_x2", "Fitpoints_x3", "Fitpoints_x4"};
   std::vector<TString> tagged = {"", "mu"};
   std::vector<TString> Tsource = {"",      "Decay",  "Hadronic inelastic", "Lepton pair", "Positron annihilation",
                                   "charm", "beauty", "Di-muon P8"};
