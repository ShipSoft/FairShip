...
{
  public:
    MufluxSpectrometer(const char* name,
                       const Double_t DX,
                       const Double_t DY,
                       const Double_t DZ,
                       Bool_t Active,
    ...
    void SetTubePitch_T1u(Double_t tubepitch_T1u,
                          Double_t T1u_const,
                          Double_t T1u_const_2,
                          Double_t T1u_const_3,
                          Double_t T1u_const_4);
    void SetTubePitch_T2v(Double_t tubepitch_T2v,
                          Double_t T2v_const,
    ...
    void SetTStationsZ(Double_t T1z,
                       Double_t T1x_z,
                       Double_t T1u_z,
                       Double_t T2z,
                       Double_t T2v_z,
     ...
     */
    MufluxSpectrometerPoint* AddHit(Int_t trackID,
                                    Int_t detID,
                                    TVector3 pos,
                                    TVector3 mom,
                                    Double_t time,
