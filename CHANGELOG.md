...
* Add `macro/makeCascadePythia8.py`, a Pythia8 version of `makeCascade.py` that writes charm or beauty cascade files in the same format, with `--pythia8-tune` (`default`, `FTFT`). `makeCascade.py` is unchanged.
