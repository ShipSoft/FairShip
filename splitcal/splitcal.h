...
class splitcal : public FairDetector
{
  ...
  public:
    ...
    void SetThickness(Double_t ActiveECALThickness,
    ...
    void SetMaterial(Double_t ActiveECALMaterial,
     ...
     */
    splitcalPoint* AddHit(Int_t trackID,
                          Int_t detID,
                          TVector3 pos,
                          TVector3 mom,
                          Double_t time,
