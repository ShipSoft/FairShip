...
splitcal::splitcal(const char* name, Bool_t active)
  ...
  void splitcal::SetEmpty(
      Double_t Empty, Double_t BigGap, Double_t ActiveECAL_gas_gap,
  ...
  void splitcal::SetThickness(
      Double_t ActiveECALThickness, Double_t ActiveHCALThickness,
      Double_t FilterECALThickness, Double_t FilterECALThickness_first,
      Double_t FilterHCALThickness, Double_t ActiveECAL_gas_Thickness) {
  ...
  void splitcal::SetMaterial(
      Double_t ActiveECALMaterial, Double_t ActiveHCALMaterial,
  ...
  void splitcal::ConstructGeometry() {
    ...
    TGeoVolume*
        newECALfilter_first;  // first layer can have different thickeness
    ...
    for (Int_t i_nlayHCAL = 0; i_nlayHCAL < 1; i_nlayHCAL++) {
      ...
      newHCALfilter[i_nlayHCAL] =
          gGeoManager->MakeBox(char_labelHCALfilter[i_nlayHCAL], A2, fXMax,
                               fYMax, fFilterHCALThickness / 2);
      if (fActiveHCAL) {
        newHCALdet[i_nlayHCAL] =
            gGeoManager->MakeBox(char_labelHCALdet[i_nlayHCAL], A4, fXMax,
                                 fYMax, fActiveHCALThickness / 2);
