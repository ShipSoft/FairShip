...
// -----   Default constructor   -------------------------------------------
splitcalHit::splitcalHit() : ShipHit()
{
   flag = true;
}
...
splitcalHit::splitcalHit(splitcalPoint *p, Double_t t0) : ShipHit()
{
...
void splitcalHit::Decoder(std::string &encodedID, int &isPrecision, int &nLayer, int &nModuleX, int &nModuleY,
                          int &nStrip)
{
