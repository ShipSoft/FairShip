...
class splitcalHit : public SHiP::DetectorHit {
 public:
  ...
  void Decoder(int id, int& isPrecision, int& nLayer, int& nModuleX,
               int& nMdouleY, int& nStrip);
  void Decoder(const std::string& encodedID, int& isPrecision, int& nLayer,
               int& nModuleX, int& nMdouleY, int& nStrip);
  ...
  void SetIDs(int isPrecision, int nLayer, int nModuleX, int nModuleY,
              int nStrip) {
    _isPrecisionLayer = isPrecision;
    _nLayer = nLayer;
    _nModuleX = nModuleX;
    _nModuleY = nModuleY;
    _nStrip = nStrip;
