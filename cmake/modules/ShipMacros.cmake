...
function(ship_add_library)
    ...
    if(NOT ARG_SOURCES)
        message(
            FATAL_ERROR
            "ship_add_library(${ARG_NAME}): SOURCES is required"
        )
    endif()
    ...
    if(ARG_LINKDEF)
        ...
        set(_rootmap_file
            ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/lib${ARG_NAME}.rootmap
        )
        ...
        set_source_files_properties(
            ${_dict_file}
            PROPERTIES GENERATED TRUE COMPILE_FLAGS "-Wno-old-style-cast"
        )
    endif()
    ...
    if(ARG_SYSTEM_INCLUDE_DIRECTORIES)
        target_include_directories(
            ${ARG_NAME}
            SYSTEM
            PRIVATE ${ARG_SYSTEM_INCLUDE_DIRECTORIES}
        )
    endif()
    ...
    if(ARG_LINKDEF)
        ...
        add_custom_command(
            ...
            COMMAND
                ...
                $<TARGET_FILE:ROOT::rootcling> -f ${_dict_file}
                -inlineInputHeader -rmf ${_rootmap_file} -rml
                $<TARGET_FILE_NAME:${ARG_NAME}>
