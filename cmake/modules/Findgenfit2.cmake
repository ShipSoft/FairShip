...
if(genfit2_FOUND AND DEFINED genfit2_INCDIR AND DEFINED genfit2_LIBDIR)
    ...
    if(NOT TARGET genfit2)
        ...
        set_target_properties(
            ...
            PROPERTIES
                IMPORTED_LOCATION
                    "${genfit2_LIBDIR}/${CMAKE_SHARED_LIBRARY_PREFIX}genfit2${CMAKE_SHARED_LIBRARY_SUFFIX}"
...
find_package_handle_standard_args(
    genfit2
    REQUIRED_VARS genfit2_LIBRARY genfit2_INCLUDE_DIR
    FAIL_MESSAGE
...
if(genfit2_FOUND)
    ...
    mark_as_advanced(genfit2_INCLUDE_DIR genfit2_LIBRARY)
endif()
