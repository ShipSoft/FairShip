...
if (EVTGEN_INCLUDE_DIR AND EVTGEN_LIB_DIR)
   set(EVTGEN_FOUND TRUE)
endif (PEVTGEN_INCLUDE_DIR AND EVTGEN_LIB_DIR)

if (EVTGEN_FOUND)
  if (NOT PEVTGEN_FOUND_QUIETLY)
    MESSAGE(STATUS "Looking for EVTGEN... - found ${PYTHIA8_LIB_DIR}")
