...
// -----   Default constructor   -------------------------------------------
muonHit::muonHit() : ShipHit() {}
// -----   Standard constructor   ------------------------------------------
muonHit::muonHit(Int_t detID, Float_t digi, Bool_t isV) : ShipHit(detID, digi)
{
   //
   SetDigi(digi);
   setValidity(isV);
...
muonHit::muonHit(muonPoint *p, Double_t t0) : ShipHit()
{
   //
...
{
   //
   cout << "-I- muonHit: muon hit "
        << " in detector " << fDetectorID << endl;
   cout << "  TDC " << fdigi << " ns" << endl;
}
//
void muonHit::setValidity(Bool_t isV)
{
   hisV = isV;
}
// -----   Destructor   ----------------------------------------------------
