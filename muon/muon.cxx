...
muon::muon()
   : FairDetector("muon", kTRUE, kMuon), fTrackID(-1), fVolumeID(-1), fPos(), fMom(), fTime(-1.), fLength(-1.),
     fELoss(-1), fmuonPointCollection(new TClonesArray("muonPoint"))
{
}

muon::muon(const char *name, Bool_t active)
   : FairDetector(name, active, kMuon), fTrackID(-1), fVolumeID(-1), fPos(), fMom(), fTime(-1.), fLength(-1.),
     fELoss(-1), fmuonPointCollection(new TClonesArray("muonPoint"))
{
}
...
muonPoint *muon::AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
