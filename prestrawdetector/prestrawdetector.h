...
class prestrawdetector : public FairDetector
{
  public:
    ...
    prestrawdetector();
    prestrawdetector(std::string medium);
    ...
    prestrawdetectorPoint* AddHit(Int_t trackID,
                                  Int_t detID,
                                  TVector3 pos,
                                  TVector3 mom,
                                  Double_t time,
  ...
  private:
    Double_t fPSDz;
    Double_t fPSDx;            //! x(half of the size) in cm
    Double_t fPSDy;            //! y(half of the size) in cm
    Double_t fPSD_Thickness;   //! thickness in cm
    std::string fMedium;
