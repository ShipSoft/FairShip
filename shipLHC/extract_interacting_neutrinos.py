...
parser.add_argument("--geniepath", type=str, dest="geniepath", default=None,help =
"Path of Genie simulated neutrinos interactions, where also to store the subsample of interacting Fluka neutrinos")
parser.add_argument("--flukapath", type=str, dest="flukapath", default=None,help =
...
hgenie_nuE = df.Histo1D(("hgenie_nuE","Energy of muon neutrinos from genie spectrum;E[GeV]",nbins,minE,maxE),"pzv")
...
hnuratio = r.TH1D("hnuratio","ratio between Genie and Fluka energies, proportional to the cross section",nbins,minE,maxE)
