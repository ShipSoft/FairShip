...
simpleTarget::simpleTarget()
   : FairDetector("simpleTarget", kTRUE, kVETO), fTrackID(-1), fVolumeID(-1), fPos(), fMom(), fTime(-1.), fLength(-1.),
     fThick(-1.), fOnlyMuons(kFALSE), fFastMuon(kFALSE), fzPos(3E8), fTotalEloss(0),
...
Bool_t simpleTarget::ProcessHits(FairVolume *vol)
{
   ...
   if (gMC->IsTrackExiting() || gMC->IsTrackStop() || gMC->IsTrackDisappeared()) {
      ...
      if (fOnlyMuons) {
         ...
         new (clref[0]) vetoPoint(0, 0, TVector3(0, 0, 0), TVector3(0, 0, 0), 0, 0, fTotalEloss, 0, TVector3(0, 0, 0),
                                  TVector3(0, 0, 0));
         return kTRUE;
      }
...
vetoPoint *simpleTarget::AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
