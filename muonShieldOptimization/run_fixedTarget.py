...
ap.add_argument('-N', '--skipNeutrinos', action=argparse.BooleanOptionalAction, dest='skipNeutrinos', default=False, help="skip neutrinos")
...
outFile = f'{outputDir}/{txt}{runnr}_{ecut}.root'
parFile = f'{outputDir}/ship.params.{txt}{runnr}_{ecut}.root'
