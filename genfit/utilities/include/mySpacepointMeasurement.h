...
public:
   ...
   mySpacepointMeasurement() : SpacepointMeasurement() { ; }

   mySpacepointMeasurement(const mySpacepointDetectorHit *detHit, const TrackCandHit *hit) : SpacepointMeasurement()
   {
