...
void tools::invertMatrix(const TMatrixDSym &mat, TMatrixDSym &inv, double *determinant)
{
   ...
   if (useCramer && mat.GetNrows() <= 6) {
      ...
      inv = mat;
      switch (mat.GetNrows()) {
      case 3: inversion = TMatrixTSymCramerInv::Inv3x3; break;
      case 4: inversion = TMatrixTSymCramerInv::Inv4x4; break;
      case 5: inversion = TMatrixTSymCramerInv::Inv5x5; break;
      case 6: inversion = TMatrixTSymCramerInv::Inv6x6; break;
      }
