...
TrackCand::TrackCand() : mcTrackId_(-1), pdg_(0), state6D_(6), cov6D_(6), q_(0)
{
   ;
}
...
TrackCand::TrackCand(const TrackCand &other)
   : TObject(other), mcTrackId_(other.mcTrackId_), pdg_(0), state6D_(other.state6D_), cov6D_(other.cov6D_), q_(other.q_)
{
   // deep copy
