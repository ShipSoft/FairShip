...
AbsTrackRep::AbsTrackRep() : pdgCode_(0), propDir_(0), debugLvl_(0)
{
   ;
}

AbsTrackRep::AbsTrackRep(int pdgCode, char propDir) : pdgCode_(pdgCode), propDir_(propDir), debugLvl_(0)
{
   ;
}
...
double AbsTrackRep::extrapolateToMeasurement(StateOnPlane &state, const AbsMeasurement *measurement,
...
void AbsTrackRep::calcJacobianNumerically(const genfit::StateOnPlane &origState, const genfit::SharedPlanePtr destPlane,
