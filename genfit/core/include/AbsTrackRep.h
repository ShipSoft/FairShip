...
public:
    ...
    */
   virtual double extrapolateToPlane(StateOnPlane &state, const genfit::SharedPlanePtr &plane,
    ...
    * If state has no covariance, jacobian and noise will only be calculated if calcJacobianNoise == true.
    */
   virtual double extrapolateToLine(StateOnPlane &state, const TVector3 &point1, const TVector3 &point2, TVector3 &poca,
                                    TVector3 &dirInPoca, TVector3 &poca_onwire, bool stopAtBoundary = false,
    ...
    * If state has no covariance, jacobian and noise will only be calculated if calcJacobianNoise == true.
    */
   virtual double extrapolateBy(StateOnPlane &state, double step, bool stopAtBoundary = false,
                                bool calcJacobianNoise = false) const = 0;

   //! extrapolate to an AbsMeasurement
   double extrapolateToMeasurement(StateOnPlane &state, const AbsMeasurement *measurement, bool stopAtBoundary = false,
                                   bool calcJacobianNoise = false) const;
   ...
   virtual void
   getPosMomCov(const MeasuredStateOnPlane &state, TVector3 &pos, TVector3 &mom, TMatrixDSym &cov) const = 0;
    ...
    */
   void calcJacobianNumerically(const genfit::StateOnPlane &origState, const genfit::SharedPlanePtr destPlane,
   ...
   virtual void setPosMomErr(MeasuredStateOnPlane &state, const TVector3 &pos, const TVector3 &mom,
                             const TVector3 &posErr, const TVector3 &momErr) const = 0;
