...
public:
   ...
   AbsMeasurement(const TVectorD &rawHitCoords, const TMatrixDSym &rawHitCov, int detId, int hitId,
...
private:
   ...
   AbsMeasurement &
   operator=(const AbsMeasurement &); // default cannot work because TVector and TMatrix = operators don't do resizing
