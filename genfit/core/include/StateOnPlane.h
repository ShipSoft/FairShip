...
public:
   ...
   double extrapolateToLine(const TVector3 &linePoint, const TVector3 &lineDirection, bool stopAtBoundary = false,
   ...
   double extrapolateToCylinder(double radius, const TVector3 &linePoint = TVector3(0., 0., 0.),
                                const TVector3 &lineDirection = TVector3(0., 0., 1.), bool stopAtBoundary = false,
                                bool calcJacobianNoise = false)
   {
      return rep_->extrapolateToCylinder(*this, radius, linePoint, lineDirection, stopAtBoundary, calcJacobianNoise);
   }
   double extrapolateToSphere(double radius, const TVector3 &point = TVector3(0., 0., 0.), bool stopAtBoundary = false,
                              bool calcJacobianNoise = false)
   {
   ...
   double extrapolateToMeasurement(const AbsMeasurement *measurement, bool stopAtBoundary = false,
                                   bool calcJacobianNoise = false)
   {
