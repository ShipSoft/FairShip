...
public:
    ...
    * numerical problems).
    */
   Track(const TrackCand &trackCand, const MeasurementFactory<genfit::AbsMeasurement> &factory,
   ...
   void deleteFitterInfo(int startId = 0, int endId = -1,
                         const AbsTrackRep *rep = NULL); // delete in range [startId, endId]. If rep == NULL, delete for
                                                         // ALL reps, otherwise only for rep.
