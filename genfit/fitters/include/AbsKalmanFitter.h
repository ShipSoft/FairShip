...
public:
   AbsKalmanFitter(unsigned int maxIterations = 4, double deltaPval = 1e-3, double blowUpFactor = 1e3)
      : AbsFitter(), minIterations_(2), maxIterations_(maxIterations), deltaPval_(deltaPval), relChi2Change_(0.2),
        blowUpFactor_(blowUpFactor), multipleMeasurementHandling_(unweightedClosestToPredictionWire), maxFailedHits_(-1)
   {
   ...
   void getChiSquNdf(const Track *tr, const AbsTrackRep *rep, double &bChi2, double &fChi2, double &bNdf,
                     double &fNdf) const;
