...
public:
   ...
   KalmanFittedStateOnPlane(const TVectorD &state, const TMatrixDSym &cov, const SharedPlanePtr &plane,
                            const AbsTrackRep *rep, double chiSquareIncrement, double ndf);
   KalmanFittedStateOnPlane(const TVectorD &state, const TMatrixDSym &cov, const SharedPlanePtr &plane,
                            const AbsTrackRep *rep, const TVectorD &auxInfo, double chiSquareIncrement, double ndf);
...
inline KalmanFittedStateOnPlane::KalmanFittedStateOnPlane() : MeasuredStateOnPlane(), chiSquareIncrement_(0), ndf_(0)
{
   ;
}
...
inline KalmanFittedStateOnPlane::KalmanFittedStateOnPlane(const TVectorD &state, const TMatrixDSym &cov,
                                                          const SharedPlanePtr &plane, const AbsTrackRep *rep,
                                                          const TVectorD &auxInfo, double chiSquareIncrement,
                                                          double ndf)
