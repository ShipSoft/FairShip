...
GblData::GblData(unsigned int aLabel, double aValue, double aPrec)
   : theLabel(aLabel), theValue(aValue), thePrecision(aPrec), theDownWeight(1.), thePrediction(0.), theParameters(),
     theDerivatives(), globalLabels(), globalDerivatives()
{
}
 ...
 */
void GblData::addDerivatives(unsigned int iRow, const std::vector<unsigned int> &labDer, const SMatrix55 &matDer,
                             unsigned int iOff, const TMatrixD &derLocal, const std::vector<int> &labGlobal,
                             const TMatrixD &derGlobal, unsigned int extOff, const TMatrixD &extDer)
{
 ...
 * \param [in] extDer Derivatives for external Parameters
 */
void GblData::addDerivatives(unsigned int iRow, const std::vector<unsigned int> &labDer, const SMatrix27 &matDer,
 ...
 */
void GblData::getLocalData(double &aValue, double &aWeight, std::vector<unsigned int> *&indLocal,
 ...
 */
void GblData::getAllData(double &aValue, double &aErr, std::vector<unsigned int> *&indLocal,
                         std::vector<double> *&derLocal, std::vector<int> *&labGlobal, std::vector<double> *&derGlobal)
{
   aValue = theValue;
 ...
 * \param [out] derLocal List of derivatives for used (local) fit parameters
 */
void GblData::getResidual(double &aResidual, double &aVariance, double &aDownWeight,
