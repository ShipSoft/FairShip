...
int randomPdg()
{
   ...
   case 3: pdg = 13; break;
   case 4: pdg = -13; break;
   case 5: pdg = 211; break;
   case 6: pdg = -211; break;
   case 7: pdg = 2212; break;
   default: pdg = 211;
   }
...
int main()
{
   ...
   case genfit::DafSimple: fitter = new genfit::DAF(false); break;
   case genfit::DafRef: fitter = new genfit::DAF(); break;
   }
   ...
   TH1D *hmomRes = new TH1D("hmomRes", "mom res", 500, -10 * resolution * momentum / nMeasurements,
