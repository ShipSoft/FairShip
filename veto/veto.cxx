...
veto::veto(const char* name, Bool_t active)
  : FairDetector(name, active, kVETO),
    ...
    f_InnerSupportThickness(2.*cm),  //!  inner support thickness of decay volume
    f_OuterSupportThickness(2.*cm),  //!  outer support thickness of decay volume
    f_LidThickness(15.*mm),  //!  thickness of Al entrance and exit lids
    ...
    VetoStartInnerX(1200. * mm),
    VetoStartInnerY(3400. * mm),
    VetoEndInnerX(4000. * mm),
    VetoEndInnerY(6000. * mm)
{
  fUseSupport=1;
  fPlasticVeto=0;
  fLiquidVeto=1;
...
TGeoVolume* veto::GeoSideObj(TString xname, 
                              ...
                              TGeoMedium *material,
                              Bool_t sens=kFALSE)
    {//TGeoVolume* LiScX = GeoSideObj(name, half space between ribs along z, width in X at the beginning,width in Y at the beginning,width in X at the end,width in Y at the end, change in width along X,change in width along y, kMagenta - 10, vetoMed, true);
...
TGeoVolume* veto::GeoCornerLiSc1(TString xname,
                                  ...
                                  bool isClockwise,
                                  double a,
                                  double b1,//b1 should be the end point
                                  double b2,
                                  double dA,
                                  double dB,
                                  Int_t color,
...
int veto::liscId(TString ShapeTypeName,int blockNr ,int Zlayer,int number, int position){
    ...
    //std::cout << "Generated ID for " << ShapeTypeName << ": " << id << std::endl;
...
void veto::AddBlock(TGeoVolumeAssembly *tInnerWall,
    ...
    //decay vacuum
	  ...
	  //outer wall
	    ...
	    TGeoVolume* TOW = GeoTrapezoidNew(nameOuterWall,wallThick,wz,wx(z1)+2*(wallThick+liscThick1),wx(z2)+2*(wallThick+liscThick2),wy(z1)+2*(wallThick+liscThick1),wy(z2)+2*(wallThick+liscThick2),ribColor,supportMedIn);
    ...
    z1_y1 = z1_y_thickness_1 / 2-wallThick+liscThick1;
    z1_y2 = z1_y_thickness_2 / 2-wallThick+liscThick2;
    ...
    for(int i=0;i<nx;i++){
      ...
      name=""; name.Form("vLongitRibX_%s_phi%d",blockName.Data(),makeId(0,z1_x1,z1_y1));
      vLongitRibX.at(i) = GeoSideObj(name,
                                     dZ,
                                     ribThick,
                                     liscThick1,
                                     ribThick, 
    ...
    z1_x1 = z1_x_thickness_1 / 2-wallThick+liscThick1;
    z1_x2 = z1_x_thickness_2 / 2-wallThick+liscThick2;
    ...
    for(int i=0;i<ny;i++){
      ...
      name=""; name.Form("vLongitRibY_%s_phi%d",blockName.Data(),makeId(0,z1_x1,z1_y1));
      vLongitRibY.at(i) = GeoSideObj(name, dZ,liscThick1,ribThick, liscThick2,ribThick,z1_x2-z1_x1, z1_y2-z1_y1,ribColor, supportMedIn);
    ...
    for(double zi=z1;zi<z2;zi+=cell_thickness_z){
      ...
      //place vertical ribs
      TString nameVR(""); nameVR.Form("VetoVerticalRib_z%d",(int)zi);
      TGeoVolume* TVR = GeoTrapezoidNew(nameVR,liscThick1,ribThick,wx(zi)+2*wallThick,wx(zi+ribThick)+2*wallThick,wy(zi)+2*wallThick,wy(zi+ribThick)+2*wallThick,ribColor,supportMedIn);
      ...
      tLongitRib->AddNode(CornerRib_L, makeId( zi, tX, tY) , new TGeoCombiTrans( tX, tY,tZ,new TGeoRotation("r",0,0,0)));
      tLongitRib->AddNode(CornerRib_L, makeId( zi,-tX,-tY) , new TGeoCombiTrans(-tX,-tY,tZ,new TGeoRotation("r",0,0,180)));
      tLongitRib->AddNode(CornerRib_R, makeId( zi,-tX, tY) , new TGeoCombiTrans(-tX, tY,tZ,new TGeoRotation("r",0,0,90)));
      tLongitRib->AddNode(CornerRib_R, makeId( zi, tX,-tY) , new TGeoCombiTrans( tX,-tY,tZ,new TGeoRotation("r",0,0,270)));
      ...
      zi_y1 =  zi_y_thickness_1/2-wallThick-liscThick1; 
      zi_y2 =  zi_y_thickness_2/2-wallThick-liscThick1; 
      ...
      for (int i = 0; i <nx; i++) 
        {
          ...
          tLongitRib->AddNode(vLongitRibX.at(i), makeId(zi,  zi_x1,  zi_y1), new TGeoCombiTrans( zi_x1-ribThick, zi_y1, tZ, new TGeoRotation("r", 0, 0,   0)));
          tLongitRib->AddNode(vLongitRibX.at(i), makeId(zi, -zi_x1, -zi_y1), new TGeoCombiTrans(-zi_x1+ribThick,-zi_y1, tZ, new TGeoRotation("r", 0, 0, 180)));
 
          if (i==0)
          {
          name=""; name.Form("LiSc_L1_%d",liscId("LiSc_L1",blockNr,Zlayer, i, 0));
          //std::cout << "Creating volume with name: " << name << std::endl;
          TGeoVolume* LiSc_L1 = GeoCornerLiSc1(name,dZ,1,zi_x1_Step-ribThick/sqrt(2)-ribThick/2-wallThick-liscThick1, liscThick2,liscThick2, zi_x2-zi_x1+ribThick, zi_y2-zi_y1, kRed-10 ,vetoMed,true);
          ttLiSc->AddNode(LiSc_L1, liscId("LiSc_L1",blockNr,Zlayer,i,1) , new TGeoCombiTrans( zi_x1, zi_y1,tZ,new TGeoRotation("r",0,0,0  )));
          

          name=""; name.Form("LiSc_L2_%d",liscId("LiSc_L2",blockNr,Zlayer, i, 0));
          //std::cout << "Creating volume with name: " << name << std::endl;
          TGeoVolume* LiSc_L2 = GeoCornerLiSc1(name,dZ,1,zi_x1_Step-ribThick/sqrt(2)-ribThick/2-wallThick-liscThick1, liscThick2,liscThick2, zi_x2-zi_x1+ribThick, zi_y2-zi_y1, kMagenta-10 ,vetoMed,true);          
          ttLiSc->AddNode(LiSc_L2, liscId("LiSc_L2",blockNr,Zlayer,i,1) , new TGeoCombiTrans(-zi_x1,-zi_y1,tZ,new TGeoRotation("r",0,0,180)));
          
          name=""; name.Form("LiSc_R1_%d",liscId("LiSc_R1",blockNr,Zlayer, i, 0));
          //std::cout << "Creating volume with name: " << name << std::endl;
          TGeoVolume* LiSc_R1 = GeoCornerLiSc1(name,dZ,0,zi_x1_Step-ribThick/sqrt(2)-ribThick/2-wallThick-liscThick1, liscThick1,liscThick2, zi_x2-zi_x1+ribThick, zi_y2-zi_y1, kMagenta-10 ,vetoMed,true);
          ttLiSc->AddNode(LiSc_R1, liscId("LiSc_R1",blockNr,Zlayer,i,1) , new TGeoCombiTrans(-zi_x1, zi_y1,tZ,new TGeoRotation("r",0,0,0  )));          

          name=""; name.Form("LiSc_R2_%d",liscId("LiSc_R2",blockNr,Zlayer, i, 0));
          //std::cout << "Creating volume with name: " << name << std::endl;
          TGeoVolume* LiSc_R2 = GeoCornerLiSc1(name,dZ,0,zi_x1_Step-ribThick/sqrt(2)-ribThick/2-wallThick-liscThick1, liscThick1,liscThick2, zi_x2-zi_x1+ribThick, zi_y2-zi_y1, kMagenta-10 ,vetoMed,true);
          ttLiSc->AddNode(LiSc_R2, liscId("LiSc_R2",blockNr,Zlayer,i,1) , new TGeoCombiTrans( zi_x1,-zi_y1,tZ,new TGeoRotation("r",0,0,180)));
          ...
          TGeoVolume* LiScX = GeoSideObj(name, dZ, zi_x1_Step, liscThick1, zi_x2_Step, liscThick2, zi_x2-zi_x1, zi_y2-zi_y1, kMagenta - 10, vetoMed, true);
          ttLiSc->AddNode(LiScX, liscId("LiScX", blockNr, Zlayer, i, 1), new TGeoCombiTrans( zi_x1 , zi_y1,tZ,new TGeoRotation("r", 0, 0, 0)));
          ttLiSc->AddNode(LiScX, liscId("LiScX", blockNr, Zlayer, i, 2), new TGeoCombiTrans(-zi_x1 ,-zi_y1,tZ,new TGeoRotation("r", 0, 0, 180)));
          }
      ...
      zi_x1 = zi_x_thickness_1/2-wallThick-liscThick1; 
      zi_x2 = zi_x_thickness_2/2-wallThick-liscThick1; 
      ...
      for(int i=0;i<ny;i++)
        {
          ...
          tLongitRib->AddNode(vLongitRibY.at(i), makeId(zi,zi_x1,zi_y1) , new TGeoCombiTrans(zi_x1,zi_y1-ribThick,tZ,new TGeoRotation("r",0,0,0)));
          tLongitRib->AddNode(vLongitRibY.at(i), makeId(zi,-zi_x1,-zi_y1) , new TGeoCombiTrans(-zi_x1,-zi_y1+ribThick,tZ,new TGeoRotation("r",0,0,180)));
          ...
          name=""; name.Form("LiSc_L1_%d",liscId("LiSc_L1",blockNr,Zlayer,i,0));
          //std::cout << "Creating volume with name: " << name << std::endl;
          TGeoVolume* LiSc_L1 = GeoCornerLiSc2(name,dZ,1,zi_y1_Step-ribThick/sqrt(2)-ribThick/2-wallThick-liscThick1, liscThick1,liscThick2,  zi_y2-zi_y1+ribThick,zi_x2-zi_x1, kMagenta-10,vetoMed,true);
          ttLiSc->AddNode(LiSc_L1, liscId("LiSc_L1",blockNr,Zlayer,i,2) , new TGeoCombiTrans(zi_x1,zi_y1 ,tZ,new TGeoRotation("r",0,0,0)));

          name=""; name.Form("LiSc_L2_%d",liscId("LiSc_L2",blockNr,Zlayer,i,0));
          //std::cout << "Creating volume with name: " << name << std::endl;
          TGeoVolume* LiSc_L2 = GeoCornerLiSc2(name,dZ,1,zi_y1_Step-ribThick/sqrt(2)-ribThick/2-wallThick-liscThick1, liscThick1,liscThick2,  zi_y2-zi_y1+ribThick,zi_x2-zi_x1, kMagenta-10,vetoMed,true);
          ttLiSc->AddNode(LiSc_L2, liscId("LiSc_L2",blockNr,Zlayer,i,2) , new TGeoCombiTrans(-zi_x1,-zi_y1 ,tZ,new TGeoRotation("r",0,0,180)));
          
          name=""; name.Form("LiSc_R1_%d",liscId("LiSc_R1",blockNr,Zlayer,i,0));
          //std::cout << "Creating volume with name: " << name << std::endl;
          TGeoVolume* LiSc_R1 = GeoCornerLiSc2(name,dZ,0,zi_y1_Step-ribThick/sqrt(2)-ribThick/2-wallThick-liscThick1, liscThick1,liscThick2, zi_y2-zi_y1+ribThick, zi_x2-zi_x1, kMagenta-10 ,vetoMed,true);
          ttLiSc->AddNode(LiSc_R1, liscId("LiSc_R1",blockNr,Zlayer,i,2) , new TGeoCombiTrans(zi_x1,-zi_y1,tZ,new TGeoRotation("r",0,0,0)));
          
          name=""; name.Form("LiSc_R2_%d",liscId("LiSc_R2",blockNr,Zlayer,i,0));
          //std::cout << "Creating volume with name: " << name << std::endl;
          TGeoVolume* LiSc_R2 = GeoCornerLiSc2(name,dZ,0,zi_y1_Step-ribThick/sqrt(2)-ribThick/2-wallThick-liscThick1, liscThick1,liscThick2, zi_y2-zi_y1+ribThick, zi_x2-zi_x1, kMagenta-10 ,vetoMed,true);
          ttLiSc->AddNode(LiSc_R2, liscId("LiSc_R2",blockNr,Zlayer,i,2) , new TGeoCombiTrans(-zi_x1,zi_y1,tZ,new TGeoRotation("r",0,0,180)));
          ...
          TGeoVolume* LiScY = GeoSideObj(name, dZ, liscThick1, zi_y1_Step, liscThick2, zi_y2_Step, zi_x2-zi_x1, zi_y2-zi_y1, kMagenta-10, vetoMed, true);
          ttLiSc->AddNode(LiScY, liscId("LiScY",blockNr,Zlayer,i,1), new TGeoCombiTrans( zi_x1, zi_y1 ,tZ,new TGeoRotation("r",0,0,0)));
          ttLiSc->AddNode(LiScY, liscId("LiScY",blockNr,Zlayer,i,2), new TGeoCombiTrans(-zi_x1,-zi_y1,tZ,new TGeoRotation("r",0,0,180)));
          }
...
TGeoVolume* veto::MakeSegments(Double_t dz,Double_t dx_start,Double_t dy_start,Double_t slopeX,Double_t slopeY,Double_t floorHeight)
  {
    ...
    //******************************** Block1 **************************************
      ...
      double wallThick = f_InnerSupportThickness;  // wall thickness
      double liscThick = f_VetoThickness;  //! thickness of liquid or plastic scintillator;
...
TGeoVolume* veto::MakeLidSegments(Int_t seg,Double_t dx,Double_t dy)
{
      ...
      //place lid
      TGeoVolume *T1Lid = gGeoManager->MakeBox("T1Lidbox",supportMedOut,dx+f_InnerSupportThickness/2,dy,f_LidThickness/2.);//make it out of 8 mm of Al.
 ...
 */
   ...
   // make the exit window
      ...
      //tDecayVol->AddNode(T6Lid, 1, new TGeoTranslation(0, 0,50+-ribthick?));
