...
// -----   Default constructor   -------------------------------------------
vetoPoint::vetoPoint() : FairMCPoint() {}
// -------------------------------------------------------------------------

// -----   Standard constructor   ------------------------------------------
vetoPoint::vetoPoint(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom,
                     Double_t tof, Double_t length, Double_t eLoss,
                     Int_t pdgcode, TVector3 Lpos, TVector3 Lmom, Int_t eventID)
...
void vetoPoint::Print() const {
  LOG(info) << "    vetoPoint: veto point for track " << fTrackID
