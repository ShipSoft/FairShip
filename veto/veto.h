...
public:
   ...
   void
   SetVesselStructure(Float_t a, Float_t b, Float_t c, TString d, Float_t l, TString e, TString f, TString v, Float_t r)
   {
    ...
    */
   vetoPoint *AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
...
private:
   ...
   */
   ...
   TGeoVolume *GeoTrapezoid(TString xname, Double_t wz, Double_t wX_start, Double_t wX_end, Double_t wY_start,
                            Double_t wY_end, Int_t color, TGeoMedium *material, Bool_t sens);
   TGeoVolume *GeoTrapezoidNew(TString xname, Double_t thick, Double_t wz, Double_t wX_start, Double_t wX_end,
                               Double_t wY_start, Double_t wY_end, Int_t color, TGeoMedium *material, Bool_t sens);
   void AddBlock(TGeoVolumeAssembly *tInnerWall, TGeoVolumeAssembly *tDecayVacuum, TGeoVolumeAssembly *tOuterWall,
   ...
   TGeoVolumeAssembly *GeoCornerRib(TString xname, double ribThick, double lt1, double lt2, double dz, double slopeX,
   ...
   TGeoVolume *GeoSideObj(TString xname, double dz, double a1, double b1, double a2, double b2, double dA, double dB,
                          Int_t color, TGeoMedium *material, Bool_t sens);
   TGeoVolume *GeoCornerLiSc1(TString xname, double dz, bool isClockwise, double a, double b1, double b2, double dA,
                              double dB, Int_t color, TGeoMedium *material, Bool_t sens);
   TGeoVolume *GeoCornerLiSc2(TString xname, double dz, bool isClockwise, double a, double b1, double b2, double dA,
                              double dB, Int_t color, TGeoMedium *material, Bool_t sens);
   ...
   void InnerAddToMap(Int_t ncpy, Double_t x, Double_t y, Double_t z, Double_t dx = -1111, Double_t dy = -1111,
                      Double_t dz = -1111);
