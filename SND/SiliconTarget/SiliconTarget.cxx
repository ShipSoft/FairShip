...
void SiliconTarget::EndOfEvent() { fSiliconTargetPointCollection->Clear(); }
...
void SiliconTarget::Register() {
  ...
  FairRootManager::Instance()->Register(name, title,
                                        fSiliconTargetPointCollection, kTRUE);
...
void SiliconTarget::Reset() { fSiliconTargetPointCollection->Clear(); }
...
SiliconTargetPoint* SiliconTarget::AddHit(Int_t trackID, Int_t detID,
  ...
  return new (clref[size]) SiliconTargetPoint(trackID, detID, pos, mom, time,
