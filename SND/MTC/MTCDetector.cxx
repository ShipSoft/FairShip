...
void MTCDetector::Reset() { fMTCDetectorPointCollection->Clear(); }

void MTCDetector::EndOfEvent() { fMTCDetectorPointCollection->Clear(); }
...
MTCDetPoint* MTCDetector::AddHit(Int_t trackID, Int_t detID, TVector3 pos,
  ...
  return new (clref[size])
      MTCDetPoint(trackID, detID, pos, mom, time, length, eLoss, pdgCode);
}
