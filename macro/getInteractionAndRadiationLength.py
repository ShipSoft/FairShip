...
# python -i $FAIRSHIP/macro/run_simScript.py --Genie -g /eos/experiment/ship/data/GenieEvents/genie-nu_mu.root
...
print mparam[1], "131.9965166676321     equivalent rad length fraction"
