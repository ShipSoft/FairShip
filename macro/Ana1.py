...
tmp=inputFile.replace("/eos/experiment/ship/data/DarkPhoton/PBC-June-3/190305/reco/","")
...
if float(h['DP'].Integral())!=0:
    ...
    RecW=float(h['DPang'].Integral())/float(h['DP'].Integral())*2.0e+20#weighted Selected/weighted Vessel
    print "new rate with float", RecW
