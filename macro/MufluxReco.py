...
try:
    opts, args = getopt.getopt(
        sys.argv[1:],
        "o:D:FHPu:n:f:g:c:hqv:sl:A:Y:i:t:",
        [
            "ecalDebugDraw",
            "inputFile=",
            "geoFile=",
...
if f.cbmsim.FindBranch("MCTrack"):
    simulation = True
else:
    simulation = False
f.Close()
...
if simulation and geoFile:
    ...
    ShipGeo = ConfigRegistry.loadpy(
        "$FAIRSHIP/geometry/charm-geometry_config.py", Yheight=dy
    )
...
if withHists:
    ...
    ut.bookHist(h, "p-fittedtracks", "p of fitted tracks", 40, 0.0, 400.0)
    ut.bookHist(h, "1/p-fittedtracks", "1/p of fitted tracks", 120, -0.2, 1.0)
    ut.bookHist(h, "pt-fittedtracks", "pt of fitted tracks", 100, 0.0, 10.0)
    ut.bookHist(h, "1/pt-fittedtracks", "1/pt of fitted tracks", 120, -0.2, 1.0)
    ut.bookHist(h, "ptruth", "ptruth", 40, 0.0, 400.0)
    ut.bookHist(
        h, "delPOverP", "Pfitted/Ptrue-1 vs Ptrue", 40, 0.0, 400.0, 50, -2.0, 2.0
    )
    ut.bookHist(
        h,
        "invdelPOverP",
        "1/Pfitted-1/Ptrue)/(1/Ptrue) vs Ptrue",
        40,
        0.0,
        400.0,
        50,
    ...
    ut.bookProf(
        h, "deltaPOverP", "Pfitted/Ptrue-1 vs Ptrue", 40, 0.0, 400.0, -10.0, 10.0
    )
    ut.bookHist(h, "Pfitted-Pgun", "P-fitted vs P-gun", 40, 0.0, 400.0, 50, 0.0, 500.0)
    ...
    ut.bookHist(
        h,
        "Px/Pzfitted-Px/Pztruth",
        "Px/Pz-fitted - Px/Pz-true vs P-true",
        40,
        0.0,
        400.0,
        100,
    ...
    ut.bookHist(
        h,
        "Py/Pzfitted-Py/Pztruth",
        "Py/Pz-fitted - Py/Pz-true vs P-true",
        40,
        0.0,
        400.0,
        50,
    ...
    ut.bookHist(
        h,
        "Px/Pzfitted-Px/Pztruth-noT4",
        "Px/Pz-fitted - Px/Pz-true vs P-true (no stereo layers)",
        40,
        0.0,
        400.0,
        100,
    ...
    ut.bookHist(
        h,
        "Py/Pzfitted-Py/Pztruth-noT4",
        "Py/Pz-fitted - Py/Pz-true vs P-true (no stereo layers)",
        40,
        0.0,
        400.0,
        50,
    ...
    ut.bookHist(h, "p-value", "p-value of fit", 100, 0.0, 1.0)
    ut.bookHist(h, "pt-kick", "pt-kick", 100, -2.0, 2.0)
    ut.bookHist(h, "nmeas-noT4", "nr measurements only T1,T2,T3", 100, 0.0, 50.0)
    ut.bookHist(h, "chi2-noT4", "Chi2/DOF only T1,T2,T3", 100, 0.0, 20.0)
    ut.bookHist(h, "nmeas-all", "nr measurements", 100, 0.0, 50.0)
    ut.bookHist(h, "chi2-all", "Chi2/DOF", 100, 0.0, 20.0)
    ut.bookHist(
        h, "p-fittedtracks-noT4", "p of fitted track only T1,T2,T3", 40, 0.0, 400.0
    )
    ut.bookHist(
        h, "1/p-fittedtracks-noT4", "1/p of fitted tracks only T1,T2,T3", 120, -0.2, 1.0
    )
    ut.bookHist(
        h, "pt-fittedtracks-noT4", "pt of fitted tracks only T1,T2,T3", 100, 0.0, 10.0
    )
    ut.bookHist(
        h,
        "1/pt-fittedtracks-noT4",
        "1/pt of fitted tracks only T1,T2,T3",
        120,
        -0.2,
        1.0,
    )
    ut.bookHist(h, "ptruth-noT4", "ptruth only T1,T2,T3", 40, 0.0, 400.0)
    ut.bookHist(
        h,
        "delPOverP-noT4",
        "Pfitted/Ptrue-1 vs Ptrue only T1,T2,T3",
        40,
        0.0,
        400.0,
        50,
    ...
    ut.bookHist(
        h,
        "invdelPOverP-noT4",
        "1/Pfitted-1/Ptrue)/(1/Ptrue) vs Ptrue only T1,T2,T3",
        40,
        0.0,
        400.0,
        50,
    ...
    ut.bookHist(
        h,
        "Pfitted-Pgun-noT4",
        "P-fitted vs P-gun only T1,T2,T3",
        40,
        0.0,
        400.0,
        50,
    ...
    ut.bookHist(h, "p-value-noT4", "p-value of fit only T1,T2,T3", 100, 0.0, 1.0)
    ut.bookHist(h, "p-fittedtracks-all", "p of fitted track", 40, 0.0, 400.0)
    ut.bookHist(h, "1/p-fittedtracks-all", "1/p of fitted tracks", 120, -0.2, 1.0)
    ut.bookHist(h, "pt-fittedtracks-all", "pt of fitted tracks", 100, 0.0, 10.0)
    ut.bookHist(h, "1/pt-fittedtracks-all", "1/pt of fitted tracks", 120, -0.2, 1.0)
    ut.bookHist(h, "ptruth-all", "ptruth", 40, 0.0, 400.0)
    ut.bookHist(
        h, "delPOverP-all", "Pfitted/Ptrue-1 vs Ptrue", 40, 0.0, 400.0, 50, -2.0, 2.0
    )
    ut.bookHist(
        h,
        "invdelPOverP-all",
    ...
    ut.bookProf(
        h, "deltaPOverP-all", "Pfitted/Ptrue-1 vs Ptrue", 40, 0.0, 400.0, -10.0, 10.0
    )
    ut.bookHist(
        h, "Pfitted-Pgun-all", "P-fitted vs P-gun only", 40, 0.0, 400.0, 50, 0.0, 500.0
    )
    ut.bookHist(h, "p-value-all", "p-value of fit", 100, 0.0, 1.0)
    ut.bookHist(h, "hits-T1", "x vs y hits in T1", 50, -25.0, 25.0, 100, -50.0, 50)
    ut.bookHist(h, "hits-T2", "x vs y hits in T2", 50, -25.0, 25.0, 100, -50.0, 50)
    ut.bookHist(
        h, "hits-T1x", "x vs y hits in T1 x plane", 50, -25.0, 25.0, 100, -50.0, 50
    )
    ut.bookHist(
        h, "hits-T1u", "x vs y hits in T1 u plane", 50, -25.0, 25.0, 100, -50.0, 50
    )
    ut.bookHist(
        h, "hits-T2x", "x vs y hits in T2 x plane", 50, -25.0, 25.0, 100, -50.0, 50
    )
    ut.bookHist(
        h, "hits-T2v", "x vs y hits in T2 v plane", 50, -25.0, 25.0, 100, -50.0, 50
    )
    ut.bookHist(h, "hits-T3", "x vs y hits in T3", 200, -100.0, 100.0, 160, -80.0, 80)
    ut.bookHist(h, "hits-T4", "x vs y hits in T4", 200, -100.0, 100.0, 160, -80.0, 80)

    ut.bookHist(
        h, "muontaggerhits", "Muon Tagger Points", 300, -150, 150, 200, -100, 100
    )
    ...
    ut.bookHist(
        h,
        "Reco_y12",
        "Number of recognized tracks, clones and ghosts in stations 1&2, Y views",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_stereo12",
        "Number of recognized tracks, clones and ghosts in stations 1&2, Stereo views",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_34",
        "Number of recognized tracks, clones and ghosts in stations 3&4",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h, "NTrueTracks_3hits", "Number of tracks with more than 3 hits.", 3, -0.5, 2.5
    )
    ...
    ut.bookHist(
        h,
        "Reco_y12_3hits",
        "Number of recognized tracks, clones and ghosts with more than 3 hits in stations 1&2, Y views",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_stereo12_3hits",
        "Number of recognized tracks, clones and ghosts with more than 3 hits in stations 1&2, Stereo views",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_34_3hits",
        "Number of recognized tracks, clones and ghosts with more than 3 hits in stations 3&4",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "NTrueTracks_Tr4",
        "Number of tracks. At least one hit in stations 1-4.",
        3,
        -0.5,
        2.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_y12_Tr4",
        "Number of recognized tracks, clones and ghosts in stations 1&2, Y views. At least one hit in stations 1-4.",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_stereo12_Tr4",
        "Number of recognized tracks, clones and ghosts in stations 1&2, Stereo views. At least one hit in stations 1-4.",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_34_Tr4",
        "Number of recognized tracks, clones and ghosts in stations 3&4. At least one hit in stations 1-4.",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_target",
        "Number of recognized target tracks, clones and ghosts.",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_muon",
        "Number of recognized muon tracks, clones and ghosts.",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        ...
        "Number of recognized muon tracks, clones and ghosts with tagger hits.",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "Reco_all_tracks",
        "Number of recognized all tracks, clones and ghosts.",
        5,
        -0.5,
        4.5,
    )
    ...
    ut.bookHist(
        h,
        "NHits_true_y12",
        "Number of hits per MC track. Stations 1&2, Y views",
        9,
        -0.5,
        8.5,
    )
    ut.bookHist(
        h,
        "NHits_true_stereo12",
        "Number of hits per MC track. Stations 1&2, Stereo views",
        9,
        -0.5,
        8.5,
    )
    ut.bookHist(
        h,
        "NHits_true_34",
        "Number of hits per MC track. Stations 3&4, Y views",
        9,
        -0.5,
        8.5,
    )
    ...
    ut.bookHist(
        h,
        "NHits_reco_y12",
        "Number of hits per Reco track. Stations 1&2, Y views",
        9,
        -0.5,
        8.5,
    )
    ut.bookHist(
        h,
        "NHits_reco_stereo12",
        "Number of hits per Reco track. Stations 1&2, Stereo views",
        9,
        -0.5,
        8.5,
    )
    ut.bookHist(
        h,
        "NHits_reco_34",
        "Number of hits per Reco track. Stations 3&4, Y views",
        9,
        -0.5,
        8.5,
    )

    ut.bookHist(h, "p/pt", "P vs Pt (GeV), Reco", 100, 0.0, 400.0, 100, 0.0, 10.0)
    ut.bookHist(
        h, "p/pt_truth", "P vs Pt (GeV), MC Truth", 100, 0.0, 400.0, 100, 0.0, 10.0
    )
    ut.bookHist(h, "p/pt_noT4", "P vs Pt (GeV), Reco", 100, 0.0, 400.0, 100, 0.0, 10.0)
    ut.bookHist(
        h, "p/pt_truth_noT4", "P vs Pt (GeV), MC Truth", 100, 0.0, 400.0, 100, 0.0, 10.0
    )
    ut.bookHist(h, "p/pt_all", "P vs Pt (GeV), Reco", 100, 0.0, 400.0, 100, 0.0, 10.0)
    ut.bookHist(
        h, "p/pt_truth_all", "P vs Pt (GeV), MC Truth", 100, 0.0, 400.0, 100, 0.0, 10.0
    )

    ut.bookHist(h, "p_rel_error", "(P_reco - P_true) / P_true", 200, -2.0, 2.0)
    ut.bookHist(h, "pt_rel_error", "(Pt_reco - Pt_true) / Pt_true", 200, -2.0, 2.0)
    ut.bookHist(h, "p_rel_error_noT4", "(P_reco - P_true) / P_true", 200, -2.0, 2.0)
    ut.bookHist(h, "pt_rel_error_noT4", "(Pt_reco - Pt_true) / Pt_true", 200, -2.0, 2.0)
    ut.bookHist(h, "p_rel_error_all", "(P_reco - P_true) / P_true", 200, -2.0, 2.0)
    ut.bookHist(h, "pt_rel_error_all", "(Pt_reco - Pt_true) / Pt_true", 200, -2.0, 2.0)

    ut.bookHist(
        h,
        "Reco_muons_vs_p_true",
        "Number of recognized muons vs P MC truth",
        40,
        0.0,
        400.0,
    )
    ut.bookHist(
        h, "Ghosts_muons_vs_p_true", "Number of ghosts vs P MC truth", 40, 0.0, 400.0
    )
    ut.bookHist(
        h, "True_muons_vs_p_true", "Number of muons vs P MC truth", 40, 0.0, 400.0
    )
    ut.bookHist(
        h, "True_all_tracks_vs_p_true", "Number of muons vs P MC truth", 40, 0.0, 400.0
    )
