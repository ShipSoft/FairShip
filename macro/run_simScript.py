...
globalDesigns = {
    ...
    "2022": {"dy": 8.0, "dv": 6, "ds": 9, "nud": 3, "caloDesign": 3, "strawDesign": 10},
    "2023": {"dy": 6.0, "dv": 6, "ds": 8, "nud": 4, "caloDesign": 3, "strawDesign": 10},
}
default = "2023"
...
parser.add_argument(
    "--muShieldDesign",
    dest="ds",
    help="7=short magnet design, 9=optimised with T4 as constraint, 8=requires config file\
...
parser.add_argument(
    "--nuTauTargetDesign",
    dest="nud",
    help="0=TP, 1=new magnet option for short muon shield, 2= no magnet surrounding neutrino detector, 3= emulsion spectrometer and muon filter as in CDS, 4= not magnetized target and muon spectrometer for ECN3",
    required=False,
...
parser.add_argument(
    "--scName", help="The name of the SC shield in the database", default="sc_v6"
)
parser.add_argument(
    "--MesonMother",
    dest="MM",
...
if (
    options.charm == 0
):  # charm and muflux testbeam not yet updated for using the new bfield interface
