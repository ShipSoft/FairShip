...
fMagField.SetField(0.0, 2.0, 0.0)  # values are in kG
fMagField.SetFieldRegion(
    -160, 160, -160, 160, 1940, 125
)  # values are in cm  (xmin,xmax,ymin,ymax,zmin,zmax)
run.SetField(fMagField)

# -----Create PrimaryGenerator--------------------------------------
primGen = ROOT.FairPrimaryGenerator()
pointZero = -decayVolumeLength / 2.0 - targetHadronAbsorber - muShieldLength - 200.0

mom = ROOT.TVector3(0.0, 0.0, 100.0)
pos = ROOT.TVector3(0.0, 0.0, pointZero)
