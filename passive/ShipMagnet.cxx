...
ShipMagnet::ShipMagnet(const char *name, const char *Title, Double_t z, Int_t c, Double_t dx, Double_t dy, Double_t fl,
                       Double_t YW, Double_t YD, Double_t CT)
...
TGeoVolume *
ShipMagnet::MagnetSupport(Double_t hwidth, Double_t hheight, Double_t dz, Int_t colour, TGeoMedium *material)
{
...
void ShipMagnet::ConstructGeometry()
{
   ...
   if (fDesign == 1) {
      ...
      tMagnet->AddNode(CV, 1,
                       new TGeoTranslation(xaperture + YokeWidth / 2., 0, fSpecMagz - YokeDepth - CoilThick / 2.));
      tMagnet->AddNode(CV, 2,
                       new TGeoTranslation(-xaperture - YokeWidth / 2., 0, fSpecMagz - YokeDepth - CoilThick / 2.));
      tMagnet->AddNode(CV, 3,
                       new TGeoTranslation(xaperture + YokeWidth / 2., 0, fSpecMagz + YokeDepth + CoilThick / 2.));
      tMagnet->AddNode(CV, 4,
                       new TGeoTranslation(-xaperture - YokeWidth / 2., 0, fSpecMagz + YokeDepth + CoilThick / 2.));
   }
}
