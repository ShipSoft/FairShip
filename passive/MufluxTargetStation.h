...
public:
   ...
   MufluxTargetStation(const char *name, const Double_t tl, const Double_t tz, const int nS, const Double_t sl,
   ...
   void SetAboveAbsorberShield(Double_t aboveabsorbershield_x, Double_t aboveabsorbershield_y,
