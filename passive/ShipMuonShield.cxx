...
//
	...
	for (Int_t nM = (fDesign == 7) ? 0 : 1; nM < 2; nM++) {
	 ...
	 mag_trans.push_back(mag1);
      ...
      auto abs = new TGeoBBox("absorber", 2.7 * m, 1.2 * m, absorber_half_length);
	...
	absorber_magnet_components +=
      ...
      if (fDesign > 7) {
         ...
         auto coatShape = new TGeoCompositeShape("CoatShape", "coat:TCC8_shift-absorber");
