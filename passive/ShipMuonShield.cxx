                                  ...
                                  Bool_t SC_key = false)
{
    ...
    if (SC_key) {
        ...
        cornersMainL = {middleGap,
                        -(dY + 3 * dX - anti_overlap),
                        middleGap,
                        dY + 3 * dX - anti_overlap,
                        dX + middleGap,
                        dY - anti_overlap,
        ...
        cornersMainSideL = fDesign == 7 ? std::array<Double_t, 16>{dX + middleGap + gap,
                                                                   -HmainSideMag,
                                                                   dX + middleGap + gap,
                                                                   HmainSideMag,
                                                                   4 * dX + middleGap + gap,
...
void ShipMuonShield::ConstructGeometry()
{
    ...
    if (fDesign >= 7 && fDesign <= 9) {
        ...
        Double_t z_transition =
            zEndOfAbsorb + 2 * absorber_half_length + absorber_offset + 14 * cm + TCC8_trench_length;
	  ...
	  "_MagTopLeft", "_MagTopRight", "_MagBotLeft", "_MagBotRight",
        ...
        if (fDesign > 7) {
            ...
            auto* coatWall_shift = new TGeoTranslation(
                "coatWall_shift", 0, 0, zEndOfAbsorb + 2 * absorber_half_length + absorber_offset + 7 * cm);
            coatWall_shift->RegisterYourself();
            auto* coatWall_shift_transition =
                new TGeoTranslation("coatWall_shift_transition",
                                    0,
                                    0,
