...
ShipGoliath::ShipGoliath() : FairModule("ShipGoliath", "") {}

ShipGoliath::ShipGoliath(const char *name, const Double_t zC, const Double_t LS, const Double_t TS,
                         const Double_t GapTS, const char *Title)
