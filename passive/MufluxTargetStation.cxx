...
MufluxTargetStation::MufluxTargetStation() : FairModule("MufluxTargetStation", "") {}
...
MufluxTargetStation::MufluxTargetStation(const char *name, const Double_t tl, const Double_t tz, const int nS,
                                         const Double_t sl, const char *Title)
   : FairModule(name, Title)
{
   fTargetLength = tl;
   fAbsorberLength = 0;
...
void MufluxTargetStation::SetConcreteShield(Double_t concreteshield_x, Double_t concreteshield_y,
...
void MufluxTargetStation::SetAboveTargetShield(Double_t abovetargetshield_x, Double_t abovetargetshield_y,
...
void MufluxTargetStation::SetAboveAbsorberShield(Double_t aboveabsorbershield_x, Double_t aboveabsorbershield_y,
...
void MufluxTargetStation::ConstructGeometry()
{
   ...
   targettube = gGeoManager->MakeTube("TargetTube", steel, fDiameter / 2. + 0.5, fDiameter / 2. + 1.1,
   ...
   abovetargetshield = gGeoManager->MakeBox("AboveTargetShield", concrete, fabovetargetshield_x, fabovetargetshield_y,
                                            fabovetargetshield_z);
   aboveabsorbershield = gGeoManager->MakeBox("AboveBsorberShield", concrete, faboveabsorbershield_x,
                                              faboveabsorbershield_y, faboveabsorbershield_z);
   aboveabovetargetshield = gGeoManager->MakeBox("AboveAboveTargetShield", concrete, fAbsorberLength,
                                                 faboveabovetargetshield_y, fAbsorberLength);
