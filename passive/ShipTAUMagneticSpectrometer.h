...
public:
   ShipTAUMagneticSpectrometer(const char *name, const Double_t zLS, const Double_t FeL, const Double_t AirL,
                               const Double_t SpectroL, const Double_t GapV, const Double_t DGap, const Double_t MGap,
                               const Double_t mf, const char *Title = "ShipTAUMagneticSpectrometer");
   ...
   ClassDef(ShipTAUMagneticSpectrometer, 1)
      ...
      protected : Double_t zLastSlab; // z distance of the center of the last Fe slab of the second spectrometer in cm
                                      // from the center of the vacuum tube
   Double_t IronLenght;
