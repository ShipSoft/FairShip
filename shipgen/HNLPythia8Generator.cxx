   ...
   do {
      ...
      if (iHNL == 0) {
         ...
         if (fextFile && *fextFile) {
            ...
            cpg->AddTrack((Int_t)mid[0], mpx[0], mpy[0], mpz[0], xm / cm + dx, ym / cm + dy, zm / cm, -1, false, mE[0],
                          0., 1.);
            cpg->AddTrack((Int_t)fPythia->event[im].id(), pmx, pmy, pmz, xm / cm + dx, ym / cm + dy, zm / cm, 0, false,
         ...
         // zm << " [mm] tm = " << tm << " [mm/c]" << endl; cout << " ----> insert HNL =" << fHNL << " pz = " << pz << "
         // [GeV] zp = " << zp << " [mm] tp = " << tp << " [mm/c]" << endl;
         iHNL = i;
      }
