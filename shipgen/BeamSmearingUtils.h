 ...
 * @param smearBeam   Standard deviation for Gaussian smearing (in units
 * appropriate for the generator)
 * @param paintBeam   Radius for uniform circular painting (in units appropriate
 * for the generator)
 * @return std::pair<Double_t, Double_t> containing (dx, dy) offsets in same
