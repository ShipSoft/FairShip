...
Bool_t MuDISGenerator::ReadEvent(FairPrimaryGenerator* cpg)
{
    ...
    // cout << "*********************************************************" << endl;
    // cout << "muon DIS Generator debug " << iMuon->GetEntries()<< " "<< iMuon->AddrAt(0) << " nf "<< nf << " fn=" <<
    // fn <<endl;
    ...
    // cout << "Info MuDISGenerator What was maximum density, mparam[7]= " << mparam[7] << ", " << mparam[7]*1.e8
    // <<endl;
    while (prob2int < gRandom->Uniform(0., 1.)) {
        ...
        if (prob2int > 1.)
            cout << "***WARNING*** MuDISGenerator: prob2int > Maximum density????" << prob2int
    ...
    for (int i = 0; i < nf; i++) {
        ...
        // cout << "muon DIS Generator out part mom " << Part[0][1]<<" " << Part[0][2] <<" " << Part[0][3] << " " <<
        // Part[0][4] << endl; cout << "muon DIS Generator out part pos " << mu[0][5]<<" " << mu[0][6] <<" " << mu[0][7]
        // << endl; cout << "muon DIS Generator out part w " << mu[0][8] << endl;
