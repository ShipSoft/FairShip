...
Bool_t MuDISGenerator::ReadEvent(FairPrimaryGenerator *cpg)
{
   ...
   // cout << "*********************************************************" << endl;
   // cout << "muon DIS Generator debug " << iMuon->GetEntries()<< " "<< iMuon->AddrAt(0) << " nf "<< nf << " fn=" << fn
   // <<endl;
   ...
   while (prob2int < gRandom->Uniform(0., 1.)) {
      ...
      if (prob2int > 1.)
         cout << "***WARNING*** MuDISGenerator: prob2int > Maximum density????" << prob2int << " maxrho:" << mparam[7]
