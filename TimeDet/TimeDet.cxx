...
TimeDet::TimeDet()
   : FairDetector("TimeDet", kTRUE, kTimeDet), fTrackID(-1), fVolumeID(-1), fPos(), fMom(), fTime(-1.), fLength(-1.),
     fELoss(-1),
     //
     fzPos(0), fxSize(450), fySize(650), fxBar(168), fyBar(6), fzBar(1), fdzBarCol(2.4), fdzBarRow(1.2), fNCol(3),
     fNRow(148), fxCenter(0), fyCenter(0),
     //
     fDetector(0),
     //
...
TimeDet::TimeDet(const char *name, Bool_t active)
   : FairDetector(name, active, kTimeDet), fTrackID(-1), fVolumeID(-1), fPos(), fMom(), fTime(-1.), fLength(-1.),
     fELoss(-1),
     //
     fzPos(0), fxSize(450), fySize(650), fxBar(168), fyBar(6), fzBar(1), fdzBarCol(2.4), fdzBarRow(1.2), fNCol(3),
     fNRow(148), fxCenter(0), fyCenter(0),
...
TimeDetPoint *TimeDet::AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
