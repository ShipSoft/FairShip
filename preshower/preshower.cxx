...
preshower::preshower()
   : FairDetector("preshower", kTRUE, kPreshower), fTrackID(-1), fVolumeID(-1), fPos(), fMom(), fTime(-1.),
     fLength(-1.), fELoss(-1), fpreshowerPointCollection(new TClonesArray("preshowerPoint"))
{
}

preshower::preshower(const char *name, Bool_t active)
   : FairDetector(name, active, kPreshower), fTrackID(-1), fVolumeID(-1), fPos(), fMom(), fTime(-1.), fLength(-1.),
     fELoss(-1), fpreshowerPointCollection(new TClonesArray("preshowerPoint"))
{
}
...
preshowerPoint *preshower::AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time,
