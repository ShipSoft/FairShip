...
ecalMatch::ecalMatch(const char *name, const Int_t verbose)
   : FairTask(name, verbose), fEv(0), fN(0), fRejected(0), fUse3x3(0), fReconstucted(NULL), fMCTracks(NULL), fStr(NULL)
{
   ;
}
...
ecalMatch::ecalMatch()
   : FairTask(), fEv(0), fN(0), fRejected(0), fUse3x3(0), fReconstucted(NULL), fMCTracks(NULL), fStr(NULL)
{
   ;
}
