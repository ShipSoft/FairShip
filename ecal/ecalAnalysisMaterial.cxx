...
ecalAnalysisMaterial::ecalAnalysisMaterial()
   : FairTask(), fTree(NULL), fEvent(0), fX(0.), fY(0.), fZ(0.), fX0(0.), fIntL(0.), fMC(NULL), fRadLen(NULL)
{
}

ecalAnalysisMaterial::ecalAnalysisMaterial(const char *name, const Int_t iVerbose)
   : FairTask(name, iVerbose), fTree(NULL), fEvent(0), fX(0.), fY(0.), fZ(0.), fX0(0.), fIntL(0.), fMC(NULL),
     fRadLen(NULL)
{
}
