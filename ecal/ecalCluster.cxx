...
ecalCluster::ecalCluster()
   : TObject(), fNum(0), fSize(0), fMaxs(0), fEnergy(0.), fPreCalibrated(-1111.), fMoment(0.), fMomentX(0.),
     fMomentY(0.), fX(0.), fY(0.), fChi2(0.), fStatus(0), fCellNums(), fPeakNums(), fPreEnergy(), fMaximums(NULL)
{
}
...
ecalCluster::ecalCluster(Int_t num, const std::list<ecalCell *> &cluster, const std::list<ecalMaximum *> &maximums)
   : TObject(), fNum(num), fSize(0), fMaxs(0), fEnergy(0.), fPreCalibrated(-1111.), fMoment(0.), fMomentX(0.),
     fMomentY(0.), fX(0.), fY(0.), fChi2(0.), fStatus(0), fCellNums(), fPeakNums(), fPreEnergy(), fMaximums(NULL)
{
