...
public:
   ecalCellMC(Int_t cellnumber, Float_t x1 = 0, Float_t y1 = 0, Float_t x2 = 0, Float_t y2 = 0, Char_t type = 0,
              Float_t energy = 0);
   ...
   inline std::map<Int_t, Float_t>::const_iterator GetTrackTimeBegin() const { return fTrackTime.begin(); }
   inline std::map<Int_t, Float_t>::const_iterator GetTrackTimeEnd() const { return fTrackTime.end(); }
