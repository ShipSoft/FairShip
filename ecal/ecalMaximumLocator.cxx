...
ecalMaximumLocator::ecalMaximumLocator() : FairTask(), fMaximums(NULL), fStr(NULL), fECut(0.015), fEvent(-1) {}

ecalMaximumLocator::ecalMaximumLocator(const char *name, Int_t verbose)
   : FairTask(name, verbose), fMaximums(NULL), fStr(NULL), fECut(0.015), fEvent(-1)
{
}
