...
TClonesArray *
ecalClusterFinder::InitPython(ecalStructure *structure, TClonesArray *maximums, ecalClusterCalibration *calib)
{
   fMaximums = maximums;
   fStr = structure;
   fCalib = calib;
...
ecalClusterFinder::ecalClusterFinder(const char *name, const Int_t verbose)
   : FairTask(name, verbose), fEv(0), fMaximums(NULL), fClusters(NULL), fStr(NULL), fInf(NULL), fPreClusters(),
     fMinClusterE(0.03), fMinMaxE(0.015)
{
   ;
}
...
ecalClusterFinder::ecalClusterFinder()
   : FairTask(), fEv(0), fMaximums(NULL), fClusters(NULL), fStr(NULL), fInf(NULL), fPreClusters(), fMinClusterE(0.03),
     fMinMaxE(0.015)
{
   ;
}
