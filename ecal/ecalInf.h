...
public:
   ...
   ecalInf()
      : TObject(), fVariables(NULL), fEcalStr(), fXPos(0.), fYPos(0.), fZPos(0.), fNLayers(0), fXSize(0), fYSize(0),
        fModuleSize(0.), fLead(0.), fScin(0.), fTyveec(0.), fThicknessLayer(0.), fCellSize(0.), fEcalSize(), fECut(0.),
        fHCut(0.), fSemiX(0.0), fSemiY(0.0), fFastMC(-1), fSuccess(-1), fFileName("") {};
