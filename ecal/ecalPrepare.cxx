...
/** --- Default constructor --------------------------------------------------- **/
ecalPrepare::ecalPrepare() : FairTask(), fPedestal(80), fADCMax(16384), fADCChannel(1.0e-3), fStr(NULL), fChannelMap()
{
   fChannelMap.clear();
}
...
ecalPrepare::ecalPrepare(const char *name, Int_t iVerbose)
   : FairTask(name, iVerbose), fPedestal(80), fADCMax(16384), fADCChannel(1.0e-3), fStr(NULL), fChannelMap()
{
   fChannelMap.clear();
}
