...
public:
    ...
    **/
   ecalPoint(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t tof, Double_t length, Double_t eLoss,
             Int_t pdgcode = 0);
   ...
   ecalPoint(Int_t trackID, Int_t detID, Double32_t tof, Double32_t eloss, UInt_t EventId = 0)
      : FairMCPoint(trackID, detID, TVector3(-1111, -1111, -1111), TVector3(-1111, -1111, -1111), tof, -1111, eloss,
                    EventId),
        fPdgCode(0){};
