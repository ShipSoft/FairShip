...
public:
   ...
   void SetStraightCalibration(Int_t celltype, TFormula *f) { fStraightCalibration[celltype] = f; }
   void SetCalibration(Int_t celltype, TFormula *f) { fCalibration[celltype] = f; }

   TFormula *StraightCalibration(Int_t celltype) const { return fStraightCalibration[celltype]; }
   TFormula *Calibration(Int_t celltype) const { return fCalibration[celltype]; }
