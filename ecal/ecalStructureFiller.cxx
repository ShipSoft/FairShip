...
ecalStructureFiller::ecalStructureFiller()
   : FairTask(), fStr(NULL), fInf(NULL), fListECALpts(NULL), fEvent(0), fInited(kFALSE), fUseMCPoints(kFALSE),
     fStoreTrackInfo(kTRUE), fFileGeo("")
{
}
// -------------------------------------------------------------------------
...
ecalStructureFiller::ecalStructureFiller(const char *name, const Int_t iVerbose, const char *fileGeo)
   : FairTask(name, iVerbose), fStr(NULL), fInf(ecalInf::GetInstance(fileGeo)), fListECALpts(NULL), fEvent(0),
     fInited(kFALSE), fUseMCPoints(kFALSE), fStoreTrackInfo(kTRUE), fFileGeo(fileGeo)
{
}
// -------------------------------------------------------------------------
