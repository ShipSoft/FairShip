...
public:
   ecalDrawerItem(ecalCell *cell, Float_t r, Float_t g, Float_t b) : fCell(cell), fR(r), fG(g), fB(b) {};
   ecalCell *fCell;
   Float_t fR;
   Float_t fG;
   Float_t fB;
...
Int_t ecalDrawer::InitPython(TClonesArray *mctracks, TClonesArray *ecalPoints, ecalStructure *structure,
...
ecalDrawer::ecalDrawer(const char *name, const Int_t iVerbose)
   : FairTask(name, iVerbose), fNamePrefix("ecal"), fC(NULL), fCellSize(8), fCX(0), fCY(0), fMaxEnergyDep(0.),
     fStr(NULL), fInf(NULL), fEdging(""), fTxt(new TText()), fCells(), fMCTracks(NULL), fPoints(NULL), fClusters(NULL),
     fInName("EcalReco"), fEventN(0), fX(0.), fY(0.), fZ(0.), fMCX(0.), fMCY(0.), fMCZ(0.), fMCMotherTrN(0), fE(0.),
     fMCE(0.), fPX(0.), fPY(0.), fPZ(0.), fMCPX(0.), fMCPY(0.), fMCPZ(0.), fChi2(0.), fPdgCode(0), fR(0.)
{
}

/** Default constructor. Requirement of ROOT system **/
ecalDrawer::ecalDrawer()
   : FairTask(), fNamePrefix("ecal"), fC(NULL), fCellSize(8), fCX(0), fCY(0), fMaxEnergyDep(0.), fStr(NULL), fInf(NULL),
     fEdging(""), fTxt(new TText()), fCells(), fMCTracks(NULL), fPoints(NULL), fClusters(NULL), fInName("EcalReco"),
     fEventN(0), fX(0.), fY(0.), fZ(0.), fMCX(0.), fMCY(0.), fMCZ(0.), fMCMotherTrN(0), fE(0.), fMCE(0.), fPX(0.),
     fPY(0.), fPZ(0.), fMCPX(0.), fMCPY(0.), fMCPZ(0.), fChi2(0.), fPdgCode(0), fR(0.)
{
}
