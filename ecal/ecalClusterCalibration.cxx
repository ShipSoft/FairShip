...
/** --- Default constructor --------------------------------------------------- **/
ecalClusterCalibration::ecalClusterCalibration() : FairTask("EcalClusterCalibration", 0)
{
   Int_t i;
...
ecalClusterCalibration::ecalClusterCalibration(const char *name, Int_t iVerbose) : FairTask(name, iVerbose)
{
   Int_t i;
