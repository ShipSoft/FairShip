...
void EmulsionMagnet::ConstructGeometry()
{
   ...
   if (fDesign == 0) // OLD, TP
   {
      ...
      // Coils Description: 2 volumes must be defined being the upper coil in Cu and the lower one in Al and also heghts
      // are different
      ...
      TGeoTranslation *tr1 =
         new TGeoTranslation(-fMagnetX / 2 + side1 / 2, fMagnetY / 2 - fBaseY - fCoilH1 / 2, -fMagnetZ / 2 + base1 / 2);
      ...
      TGeoTranslation *tr1low =
         new TGeoTranslation(-fMagnetX / 2 + side1 / 2, fMagnetY / 2 - fBaseY - fCoilH1 - (fCoilDist + fCoilH2) / 2,
                             -fMagnetZ / 2 + side2 / 2);
      ...
      TGeoTranslation *tr2low =
         new TGeoTranslation(-fMagnetX / 2 + side1 + side3 / 2,
                             fMagnetY / 2 - fBaseY - fCoilH1 - (fCoilDist + fCoilH2) / 2, -fMagnetZ / 2 + base2 / 2);
      ...
      TGeoTranslation *tr1_d =
         new TGeoTranslation(fMagnetX / 2 - side1 / 2, fMagnetY / 2 - fBaseY - (fCoilH1 + fCoilH2 + fCoilDist) / 2,
                             -fMagnetZ / 2 + base1 / 2);
      ...
      TGeoCombiTrans tr2_d(fMagnetX / 2, fMagnetY / 2 - fBaseY - (fCoilH1 + fCoilH2 + fCoilDist) / 2, -fMagnetZ / 2,
                           r2_d);
      ...
      TGeoCombiTrans tr2_c(fMagnetX / 2, fMagnetY / 2 - fBaseY - (fCoilH1 + fCoilH2 + fCoilDist) / 2, fMagnetZ / 2,
                           r2_c);
   ...
   if (fDesign == 1) // NEW with magnet
   {
      ...
      *m1_l = trans1l;
      ...
      MagnetVol->AddNode(ColumnVol, 1,
                         new TGeoTranslation(0, fMagnetY / 2 - fColumnY / 2, -fMagnetZ / 2 + fColumnZ / 2));
      MagnetVol->AddNode(ColumnVol, 2,
                         new TGeoTranslation(0, fMagnetY / 2 - fColumnY / 2, fMagnetZ / 2 - fColumnZ / 2));
      MagnetVol->AddNode(ColumnVol, 3,
                         new TGeoTranslation(0, -fMagnetY / 2 + fColumnY / 2, -fMagnetZ / 2 + fColumnZ / 2));
      MagnetVol->AddNode(ColumnVol, 4,
                         new TGeoTranslation(0, -fMagnetY / 2 + fColumnY / 2, fMagnetZ / 2 - fColumnZ / 2));
      ...
      tTauNuDet->AddNode(PillarVol, 1,
                         new TGeoTranslation(-fMagnetX / 2 + fPillarX / 2, -fMagnetY / 2 - fPillarY / 2,
                                             fCenterZ - fMagnetZ / 2 + fPillarZ / 2));
      tTauNuDet->AddNode(PillarVol, 2,
                         new TGeoTranslation(fMagnetX / 2 - fPillarX / 2, -fMagnetY / 2 - fPillarY / 2,
                                             fCenterZ - fMagnetZ / 2 + fPillarZ / 2));
      tTauNuDet->AddNode(PillarVol, 3,
                         new TGeoTranslation(-fMagnetX / 2 + fPillarX / 2, -fMagnetY / 2 - fPillarY / 2,
                                             fCenterZ + fMagnetZ / 2 - fPillarZ / 2));
      tTauNuDet->AddNode(PillarVol, 4,
                         new TGeoTranslation(fMagnetX / 2 - fPillarX / 2, -fMagnetY / 2 - fPillarY / 2,
                                             fCenterZ + fMagnetZ / 2 - fPillarZ / 2));
   }
   ...
   if (fDesign == 3) // NEW with magnet
   {
      ...
      TGeoTrd2 *Model =
         new TGeoTrd2("Model", fCutHeight / 2, 0, (fColumnZ + delta) / 2, (fColumnZ + delta) / 2,
      ...
      TGeoTranslation *transcuttop = new TGeoTranslation("transcuttop", 0, fCutHeight / 2 + SemiLateralBoxHeight / 2,
      ...
      TGeoCompositeShape *cuttopleft = new TGeoCompositeShape(
         "CUTTOPLEFT", "CUTLEFT - (S:transcuttop) - (S:transcutbottom)"); // triangular cut in the left lateral wall
      ...
      const TGeoTranslation transtube("transtube", 0., -(fCoilH2 - 2 * fCoilThickness) / 2,
                                      -fCoilThickness - fCoilY / 2);
      const TGeoTranslation transtube1("transtube1", 0., (fCoilH2 - 2 * fCoilThickness) / 2,
                                       -fCoilThickness - fCoilY / 2);
      const TGeoTranslation transtube2("transtube2", 0., -(fCoilH2 - 2 * fCoilThickness) / 2,
                                       +fCoilThickness + fCoilY / 2);
      const TGeoTranslation transtube3("transtube3", 0., (fCoilH2 - 2 * fCoilThickness) / 2,
                                       +fCoilThickness + fCoilY / 2);
      ...
      TGeoBBox *Coil = new TGeoBBox("Coil", fCoilX / 2, fCoilY / 2,
                                    (fMagnetZ - 2 * OuterRadius) / 2); // two times the external radius
