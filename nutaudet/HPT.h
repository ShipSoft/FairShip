...
public:
   Hpt(const char *name, const Double_t DX, const Double_t DY, const Double_t DZ, Bool_t Active,
   ...
   void SetSciFiParam(Double_t scifimat_width, Double_t scifimat_hor, Double_t scifimat_vert, Double_t scifimat_z,
                      Double_t support_z, Double_t honeycomb_z);
    ...
    */
   HptPoint *AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
