...
public:
   ...
   void SetEmulsionParam(Double_t EmTh, Double_t EmX, Double_t EmY, Double_t PBTh, Double_t EPlW, Double_t LeadTh,
                         Double_t AllPW);
   ...
   void DecodeBrickID(Int_t detID, Int_t &NWall, Int_t &NRow, Int_t &NColumn, Int_t &NPlate, Bool_t &EmCES,
   ...
   TargetPoint *AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
...
protected:
   ...
   Bool_t fsingleemulsionfilm; // 0 = both top and bottom layers active, separated by plastic base; 1 = only one active
                               // layer
