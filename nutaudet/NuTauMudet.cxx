...
void NuTauMudet::ConstructGeometry()
{
    ...
    if (fDesign == 4) {
        ...
        volMagRegion->AddNode(
            ...
            2,
            new TGeoTranslation(
                0, 0, -fZtot / 4. - fGapMiddle / 2. - fZRpc / 2.));   // these are INSIDE the magnetized region
        volMagRegion->AddNode(volRPC, 3, new TGeoTranslation(0, 0, -fZtot / 4. + fGapMiddle / 2. + fZRpc / 2.));
        // magnetized region in the middle
        volMagRegion->AddNode(
            volRPC,
            4,
            new TGeoTranslation(0, 0, -fGapMiddle / 2. - fZRpc / 2.));   // these are INSIDE the magnetized region
