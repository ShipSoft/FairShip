...
public:
   TargetTracker(const char *name, Double_t TTX, Double_t TTY, Double_t TTZ, Bool_t Active,
   ...
   void SetSciFiParam(Double_t scifimat_width_, Double_t scifimat_hor_, Double_t scifimat_vert_, Double_t scifimat_z_,
   ...
   TTPoint *AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
