...
// -----   Default constructor   -------------------------------------------
ShipParticle::ShipParticle() : TParticle() {}
// -------------------------------------------------------------------------
ShipParticle::ShipParticle(Int_t pdg, Int_t status, Int_t mother1, Int_t mother2, Int_t daughter1, Int_t daughter2,
                           Double_t px, Double_t py, Double_t pz, Double_t etot, Double_t vx, Double_t vy, Double_t vz,
                           Double_t time)
   : TParticle(pdg, status, mother1, mother2, daughter1, daughter2, px, py, pz, etot, vx, vy, vz, time),
     fCovP(TMatrixDSym(4)), fCovV(TMatrixDSym(3))
{
   doca = 0.;
}
...
ShipParticle::ShipParticle(Int_t pdg, Int_t status, Int_t mother1, Int_t mother2, Int_t daughter1, Int_t daughter2,
   ...
   : TParticle(pdg, status, mother1, mother2, daughter1, daughter2, p, v), fCovP(TMatrixDSym(4)), fCovV(TMatrixDSym(3))
{
   doca = 0.;
}
