...
enum DetectorId {kVETO, ktauRpc, ktauHpt, ktauTT, ktauTarget, kStraw, kecal, khcal, kMuon ,kPreshower,kTRSTATION, kBox1, kSpectrometer, kScintillator, kMufluxSpectrometer, kMuonTagger};
